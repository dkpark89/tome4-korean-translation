...
newTalent{
	...
	info = function(self, t)
		...
		return ([[연금술 폭탄을 던질 때 화염의 힘을 주입하여 연금술 폭탄의 피해량이 %d%% 증가하고, 적들에게 화상 상태효과를 추가로 일으킵니다. (단, 화상 상태효과로 인해 연금술 폭탄의 피해량이 몇 턴에 걸쳐 분산됩니다)]]):
		format(100 * daminc)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		그리고 모든 화염 피해의 %d%% 가 산성 피해로 전환됩니다. (단, 전환된 속성은 특수효과를 발생시키지 않습니다)]]):
...
newTalent{
	...
	info = function(self, t)
		...
		그리고 모든 화염 피해의 %d%% 가 전기 피해로 전환됩니다. (단, 전환된 속성은 특수효과를 발생시키지 않습니다)]]):
		format(100 * daminc, conv)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		그리고 모든 화염 피해의 %d%% 가 냉기 피해로 전환됩니다. (단, 전환된 속성은 특수효과를 발생시키지 않습니다)]]):
		format(100 * daminc, conv)
	end,
}
