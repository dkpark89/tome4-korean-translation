...
newLore{
	...
	lore = [[#{bold}#3800 : #{normal}#엄청난 로비 활동 끝에, 금을 기반으로 한 화폐 제도가 다른 종족들의 인정을 받았다. 우리의 광산에는 금 광맥이 많지만, 특별히 쓸 일이 없기 때문이다. 금을 더 비축해둘 필요가 있다.
...
#{bold}#6827 : #{normal}#핏빛 용 크롤타르를 죽이고, 그가 모은 - 총 금화 200 만 개의 가치에 해당하는 - 귀중품들을 회수하였다. 이를 위해 손실된 자원은 금화 70 만 개 정도이다. (희생된 1 인 당 금화 350 개로 환산) 즉 최종 수입은 금화 130 만 개로, 186% 의 이윤을 보았다!
...
newLore{
	...
	lore = [[#{bold}#412 : #{normal}#질병과 식량 부족으로 인해, 다른 종족들과의 거래가 줄어들었다. 우리의 위대한 역사에 있어 처음으로 적신호가 들어왔다. 사람들 사이의 도덕은 언제나 최악이었으며, 이는 생산성에 악영향을 끼쳤다.
