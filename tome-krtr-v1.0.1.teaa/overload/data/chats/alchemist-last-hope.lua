...
newChat{ id="ominous",
	text = [[시체의 신이시여, 내가 이래서 모험가를 좋아한다니깐. 나도 한때는 모험가가 될 뻔 했었지. 그 놈이 날 갑자기 때렸을 때 말이야. 여기서 "그 놈"은 물론 "내 마누라"를 말하는거야. 하핫!]],
	answers = {
...
newChat{ id="help",
	text = [[나는 최고의 계획을 만들어내지. 그리고 술도 마찬가지고. 아마 형제단도 내가 만든 술을 거기서는 '엘릭서' 라고 부르는 데에 의의를 제기하지 못할걸세. 뭐, 그들에게는 그들이 원하는 방법이라는게 있으니 '엘릭서' 라고 불러주는게 맞겠지. 그런데, 우리 지금 무슨 얘기 하고있었더라?]],
	answers = {
