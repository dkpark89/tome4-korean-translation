...
강력한 사령술사가 마침내 생과 사의 기로를 넘어선다면, 전에는 한 방울 겨우 쥐어짜 사용했던 심연의 힘을 완전히 제어해서 사용하게 돼. 얘기치 않은 지진, 농작물의 죽음, 나무에서 한번에 떨어지는 낙엽들이 리치의 탄생을 예언한다고 종종 말하기도 하지. 언데드 군주인 리치는 구울과 스켈레톤을 전멸시킬 수 있고, 처다보는것 만으로도 드레드를 추방할 수 있으며, 해골 거인을 한순간에 뼛가루로 만들어 버릴 수 있어.

어떻게 하면 리치를 실제로 파괴할 수 있을까? 음, 뭐라 말해줄까. 만약에 리치랑 맞짱뜰 상황이 생긴다면 날 위한 안내서를 써주겠어? 진짜로, 정말로, 어떻게 할지 모르겠어.
