...
제군들은 갈망해야 한다. 나는 단지 두려움의 영역을 지배하는 것만으로는 만족할 수 없다. 나는 더욱 더 많은, 훨씬 많은 것들을 지배하게 될 것이다. 나의 신발은 언젠가 지면을 밟게 될 것이다! 나는 가장 아름다운 산들을 찾아 파괴할 것이다. 내가 다시 한번 태양 밑을 거니는 순간, 모든 것은 나의 것이 될 것이다. 제군들은 어떻게 할 것인가? 내가 어제 일으킨 와이트보다 더 강한 존재가 되고 싶은가? 나는 지상을 정복할 때 언데드 군대를 통솔할 수 있는 자가 필요하다.
]],
}
