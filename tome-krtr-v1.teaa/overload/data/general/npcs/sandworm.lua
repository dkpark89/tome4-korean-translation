...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	desc = [[날개없는 용처럼 생긴 부정한 생물입니다. 지렁이와 비슷한 색깔을 가지고 있습니다.]],
	rarity = 5,
	rank = 3,
	size_category = 5,
...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	on_die = function(self, src)
		...
		game.logSeen(self, "%s 산성 구름에 갇혀, 폭발합니다.", (self.kr_display_name or self.name):capitalize():addJosa("가"))
	end,
}
