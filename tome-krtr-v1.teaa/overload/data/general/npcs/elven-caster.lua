...
newEntity{ base = "BASE_NPC_ELVEN_CASTER",
	...
	kr_display_name = "엘프 대기술사",
	desc = [[오존의 냄새가 나고 파직거리는 파란 로브를 입은 엘프 마법사입니다.]],
...
newEntity{ base = "BASE_NPC_ELVEN_CASTER",
	...
	kr_display_name = "엘프 타락자",
	desc = [[이 황폐화된 대지에 오염된 엘프 타락자입니다.]],
