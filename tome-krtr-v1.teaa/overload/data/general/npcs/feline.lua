...
newEntity{ base = "BASE_NPC_CAT",
	...
	kr_display_name = "퓨마",
	desc = [[커다란 검은 고양이과 짐승으로, 날씬하고 근육질입니다.]],
...
newEntity{ base = "BASE_NPC_CAT",
	...
	kr_display_name = "호랑이",
	desc = [[노란바탕에 검은 줄무늬를 가진 정말 웅장한 짐승입니다.]],
...
newEntity{ base = "BASE_NPC_CAT",
	...
	kr_display_name = "검치호",
	desc = [[이 고양이과 짐승은 가단히 말하자면 엄청납니다. 커다랗고 날카로운 단검같은 송곳니를 가지고 있습니다.]],
