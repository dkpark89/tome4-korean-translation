...
newEntity{ base = "BASE_NPC_ORC_VOR",
	...
	kr_display_name = "오크 화염술사",
	desc = [[밝은 빨간 로브를 입은 오크입니다. 무자비한 혀로 뭔가 중얼거립니다.]],
...
newEntity{ base = "BASE_NPC_ORC_VOR",
	...
	kr_display_name = "오크 냉기술사",
	desc = [[차가운 파란 로브를 입은 오크입니다. 무자비한 혀로 뭔가 중얼거립니다.]],
	level_range = {35, nil}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(100,110), life_rating = 10,
	resolvers.equip{
