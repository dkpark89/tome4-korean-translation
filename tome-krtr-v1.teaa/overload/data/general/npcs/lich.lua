...
newEntity{
	...
	desc = [[가장 강력한 주문의 사용자만이 역생하여 리치로 되살아날 수 있습니다. 영원히 세상에 출몰하는 운명을 가졌고, 그들의 영역을 지나거나 숨쉬는 모든 존재에 대한 혐오감이 자라납니다. 불행하지만 당신도 거기 속합니다.]],
...
newEntity{ base = "BASE_NPC_LICH",
	...
	kr_display_name = "고대의 리치",
	resolvers.nice_tile{image="invis.png", add_mos = {{image="npc/undead_lich_ancient_lich.png", display_h=2, display_y=-1}}},
	desc=[[나이조차 잊어버린 장로입니다. 살아있는 존재에대한 증오심과 분노로 채워졌고, 자신이 가지지 못한 보물... 생명을 다른 모든 것으로부터 빼앗으려 노력합니다.]],
...
newEntity{ base = "BASE_NPC_LICH",
	...
	kr_display_name = "고위 리치",
	resolvers.nice_tile{image="invis.png", add_mos = {{image="npc/undead_lich_archlich.png", display_h=2, display_y=-1}}},
	desc=[[깊은 어둠보다 검은, 어둠에 붙어있는 차갑고 잔인한 존재입니다. 오래전에 스스로의 필멸성을 벗어났지만, 그 힘을 잊지는 않았습니다. 악의와 증오심은 이 언데드가 모든 살아있는 존재를 파괴하는 것에 열중하는 힘이 되고 있습니다.]],
...
newEntity{ base = "BASE_NPC_LICH",
	...
	kr_display_name = "피의 리치",
	desc=[[참혹하게도 강력한 사랑술사에게서 끓고 퍼올려져 육체에서 이탈한 피로 이루어진 존재입니다. 이것을 치는 것은 공포의 영역의 강에서 목욕을 하는 것과 같습니다.]],
	level_range = {45, nil}, exp_worth = 1,
	rarity = 30,
	max_life = resolvers.rngavg(100,150),
