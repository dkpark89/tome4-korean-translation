...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	kr_display_name = "전기 뱀장어",
	desc = "뱀같이 생긴 존재로, 전기를 내뿜고 있습니다.",
	level_range = {1, nil}, exp_worth = 1,
	rarity = 4,
...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	kr_display_name = "용거북이",
	desc = "거대하고 기다란 바다의 녹색 파충류입니다.",
	level_range = {1, nil}, exp_worth = 1,
	rarity = 5,
	rank = 2,
...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	kr_display_name = "고대 용거북이",
	desc = "거대하고 기다란 바다의 녹색 파충류입니다. 오랜 세월동안 살아온 듯 해 보이고, 관통할 수 없을 것 같습니다.",
...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	kr_display_name = "먹물 오징어",
	desc = "많은 촉수를 당신쪽으로 뻗고 있고, 그 탁한 먹물로 시야를 가리려 합니다.",
	level_range = {1, nil}, exp_worth = 1,
	rarity = 2,
	stats = { mag=30, },
