...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	kr_display_name = "개라말쓰",
	desc = [[이 교활한 거미는 자신의 영역을 계속 키우면서, 그 안으로 들어오는 모든 것을 위협합니다. 이 것을 만나고고 살아돌아온 존재는 거의 없습니다.]],
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	kr_display_name = "니누를힝",
	desc = [[유독성 향기로 악취가 나고, 주변의 땅은 썩어갑니다.]],
	level_range = {27, nil}, exp_worth = 1,
	rarity = 3,
	max_life = 120,
	life_rating = 13,
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = [[거미류 중 가장 큰 녀석입니다. 접혀진 피부는 뚫는 것이 거의 불가능해 보입니다.]],
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	kr_display_name = "로셀힝",
	desc = [[이 쌀쌀한 거미 주변의 공기가 딱딱하게 얼고 있습니다.]],
	level_range = {27, nil}, exp_worth = 1,
	rarity = 4,
	max_life = 120,
	life_rating = 14,
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	kr_display_name = "어린 무당거미",
	desc = [[현실 바깥의 존재가 되어가고 있는 작은 거미류입니다.]],
	level_range = {7, nil}, exp_worth = 1,
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	kr_display_name = "무당거미 족장",
	desc = [[흉부에 흰 반점이 있는 크고 푸른 거미류입니다. 시간의 흐름에 부분적으로만 연결되어 있어 변화하고 어른거립니다.]],
	level_range = {27, nil}, exp_worth = 1,
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = [[현실 바깥의 존재로써 변화하고 어른거리는 거대한 푸르고 흰 거미류입니다. 그녀의 거미줄로 숙명의 흐름을 잣고, 모든 운명을 묶습니다.]],
