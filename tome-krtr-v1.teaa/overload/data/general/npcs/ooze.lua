...
newEntity{ base = "BASE_NPC_OOZE",
	...
	kr_display_name = "젤라틴 덩어리",
	desc = [[이상하고 방대한 젤라틴 구성물입니다. 정육면체의 비율로 짐작되고, 그가 지나는 통로의 사방으로 딱 들어맞는 직육면체의 비율로 짐작됩니다.
투명한 젤리 성분을 통해서, 그것이 집어 삼킨 보물들과 시체들이 보입니다.]],
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	kr_display_name = "믿기지않게 투명한 진흙 덩어리",
	blood_color = colors.WHITE,
	desc = "투명한 진흙 덩어리입니다.",
	level_range = {25, nil}, exp_worth = 1,
	rarity = 1,
