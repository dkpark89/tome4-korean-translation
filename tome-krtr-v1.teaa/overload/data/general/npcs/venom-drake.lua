...
newEntity{ base = "BASE_NPC_VENOM_DRAKE",
	...
	kr_display_name = "산성 드레이크 해츨링",
	desc = [[부식성 드레이크 해츨링입니다. 아직 아주 강력하지는 않지만, 보통 그 형제들과 무리지어 다닙니다.]],
...
newEntity{ base = "BASE_NPC_VENOM_DRAKE",
	...
	kr_display_name = "산성 드레이크",
	desc = [[성숙한 부식성 드레이크입니다. 치명적인 브레스를 사용할 수 있고 험악한 발톱을 가졌습니다.]],
