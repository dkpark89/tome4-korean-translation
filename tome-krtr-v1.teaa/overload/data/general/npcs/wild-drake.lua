...
newEntity{ base = "BASE_NPC_WILD_DRAKE",
	...
	kr_display_name = "소용돌이 용",
	desc = [[참을성있고 증오에 찬 똬리를 틀고 있는 괴물같은 이무기입니다. 그 가죽은 가시와 깃 그리고 칼날로 장식되어 있어, 강철과 마법을 모두 쉽게 빗나가게 만듭니다.]],
...
newEntity{ base = "BASE_NPC_WILD_DRAKE",
	...
	kr_display_name = "순간이동 이무기",
	desc = [[모양이 변하고 꼬불꼬불한 뱀같은 용입니다. 현실 너머로 순간이동을 하여 왕복하여, 어느새 당신의 뒤쪽에 서 있습니다.]],
