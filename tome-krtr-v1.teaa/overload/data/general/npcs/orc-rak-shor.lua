...
newEntity{ base = "BASE_NPC_ORC_RAK_SHOR",
	...
	kr_display_name = "오크 사령술사",
	desc = [[검은 로브를 입은 오크입니다. 무자비한 혀로 뭔가 중얼거립니다.]],
...
newEntity{ base = "BASE_NPC_ORC_RAK_SHOR",
	...
	kr_display_name = "오크 피의 마법사",
	desc = [[핏자국이 난 로브를 입은 오크입니다. 무자비한 혀로 뭔가 중얼거립니다.]],
...
newEntity{ base = "BASE_NPC_ORC_RAK_SHOR",
	...
	kr_display_name = "오크 타락자",
	desc = [[썩은 로브를 입은 오크입니다. 무자비한 혀로 뭔가 중얼거립니다.]],
	level_range = {27, nil}, exp_worth = 1,
	rarity = 4,
	rank = 3,
