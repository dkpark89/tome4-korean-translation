...
newEntity{ base = "BASE_NPC_ORC",
	...
	desc = [[번들거리는 길고 검은 머리카락과 기름진 마맛자국이있는 피부를 가진 병적으로 비대한 오크입니다. 판갑을 입고 자신만큼 거대한 화강암 대형도끼를 들고 있습니다.]],
