...
newEntity{ base = "BASE_NPC_MAJOR_DEMON",
	...
	kr_display_name = "대장장이 거인",
	desc = [[지하 세계의 연마용 망치를 양손에 든, 불타는 거인입니다. 그 무기는 울흐'록의 힘을 사용하여 만들어졌으며, 힘이 주입되어 있습니다. 만약 당신이 모험을 원한다면, 그의 사정거리 안쪽으로 들어가면 됩니다.]],
