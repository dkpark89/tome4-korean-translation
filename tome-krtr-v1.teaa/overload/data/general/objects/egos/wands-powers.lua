...
newEntity{
	...
	resolvers.charm(function(self) return ("전격 발사 (%d - %d 피해)"):format(self:getCharmPower()/3, self:getCharmPower()) end, 6, function(self, who)
...
newEntity{
	...
	charm_power_def = {add=25, max=250, floor=true},
	resolvers.charm(function(self) return ("임의의 원소 속성 탄환을 발사 (%d - %d 피해)"):format(self:getCharmPower()/2, self:getCharmPower()) end, 6, function(self, who)
