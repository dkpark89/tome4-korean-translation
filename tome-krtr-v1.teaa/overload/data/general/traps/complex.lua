...
newEntity{ base = "TRAP_COMPLEX",
	...
	triggered = function(self, x, y, who)
		...
		local tg = {name="huge boulder", kr_display_name = "거대한 바위", type="bolt", range=core.fov.distance(x, y, self.spawn_x, self.spawn_y), x=self.spawn_x, y=self.spawn_y, speed=2, display={image="trap/trap_big_boulder_01.png"}, blur_move=4}
