...
newIngredient{ id = "SKELETON_MAGE_SKULL",
	...
	desc = [[해골 마법사의 두개골입니다. 눈은 빛나지 않고 있습니다... 지금까지는요.]],
	min = 0, max = INFINITY,
...
newIngredient{ id = "BONE_GOLEM_DUST",
	...
	kr_display_name = "뼈 거인의 가루 주머니",
	desc = [[뼈 거인을 움직이던 마법이 사라지면, 뼈 거인은 부서져 가루가 됩니다. 가루를 자세히 보고 있으면, 왠지 모르게 가끔 가루가 스스로 움직이는 것 같습니다. 뭐, 상상력이 워낙 풍부해서 그렇게 보이는 거겠죠.]],
	min = 0, max = INFINITY,
...
newIngredient{ id = "ICE_WYRM_TOOTH",
	...
	name = "ice wyrm tooth",
	kr_display_name = "얼음용 이빨",
	desc = [[세월에 의해 조금 닳았지만, 아직 그 역할을 충분히 할 수 있을 것 같은 이빨입니다.]],
	min = 0, max = INFINITY,
	alchemy_text = "얼음용은 이빨이 자주 빠지니까, 운이 좋으면 싸우지 않고도 구할 수 있을게야. 하지만 옷은 따뜻하게 입고 가야하네.",
}
...
newIngredient{ id = "LUMINOUS_HORROR_DUST",
	...
	kr_display_name = "밤에 빛나는 공포의 가루 주머니",
