...
다시 묻지. 방금 전 말은 진심인가?]],
	answers = {
		{"그렇습니다. 저를 죽여주십시오.", action=function(npc, player) game:getPlayer(true):die(game.player, {special_death_msg=("%s는 에이오돈의 공간에서 편안하게 죽음을 맞이했습니다."):format(game.player.female and "그녀" or "그")}) end},
