...
newEntity{ base = "BASE_NPC_POINT_ZERO_TOWN", define_as = "DEFENDER_OF_REALITY",
	...
	desc = [[엄격해 보이는 수호자입니다. 괴리의 위협을 대비해 조금도 방심하지 않고 있습니다.]],
...
newEntity{ base = "BASE_NPC_POINT_ZERO_TOWN", define_as = "ZEMEKKYS",
	...
	kr_display_name = "고위 진실의 감시원, 제메키스",
	image = "npc/humanoid_elf_high_chronomancer_zemekkys.png",
	subtype = "shalore",
	desc = [[시간에서 벗어난 엘프가 당신의 앞에 서 있습니다. 그의 나이는 짐작조차 가지않고, 그가 많은 일을 겪었다고 느껴집니다.]],
...
newEntity{ define_as = "TEMPORAL_DEFILER",
	...
	desc = [[손가락마다 긴 손톱이 붙어있고, 날카로운 이빨을 가진 거대하고 호리호리한 금속질 괴물입니다. 그것은 여기에서 무엇인가를 찾고 있는것 같습니다.]],
