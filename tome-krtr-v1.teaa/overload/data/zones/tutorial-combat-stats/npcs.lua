...
newEntity{ define_as = "TUT_GUIDE",
	...
	desc = [[쇠스랑을 든 채로 환영의 미소를 띄우는 사람입니다.]],
...
newEntity{ base = "BASE_NPC_CANINE", define_as = "TUTORIAL_NPC_LONE_WOLF",
	...
	desc = [[보통의 늑대보다 겨우 3 배 밖에 크지 않으며, 교활함으로 가득 찬 눈을 가진 커다란 늑대입니다. 배가 고파 보이며, 당신이 맛있는 음식으로 보이는 것 같습니다!]],
...
newEntity{ base = "BASE_NPC_ELVEN_CASTER",
	...
	kr_display_name = "로브를 입은 엘프",
	image="npc/humanoid_shalore_elven_blood_mage.png",
	desc = [[그 손가락의 움직임과 노래하는 모습으로 볼 때, 좋은 곳에서 살아온 엘프로 보입니다.]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	mana_regen = 20,
	positive_regen = 20,
