...
newEntity{ define_as="KYLESS",
	...
	killer_message = "그리고 그의 타락한 개들의 먹잇감이 되었습니다.",
...
newEntity{ define_as="BERETHH",
	...
	desc = "당신의 옛 친구인 베레쓰입니다. 몸에 익숙한 가죽 갑옷을 입고, 능숙하게 활을 쥐고 있습니다. 그가 가는 길은 숭고해 보였지만, 이제 그는 아무런 감정도 내비치지 않습니다.",
	killer_message = "그리고 순식간에 불타올라 재가 되었습니다.",
	level_range = {20, 35}, exp_worth = 2,
	rank = 4,
	autolevel = "archer",
