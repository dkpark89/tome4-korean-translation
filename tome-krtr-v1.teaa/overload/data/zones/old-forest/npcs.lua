...
newEntity{ base = "BASE_NPC_RODENT",
	...
	kr_display_name = "작고 귀여운 토끼",
	desc = [[이것은 작고 귀여운 눈으로 당신을 쳐다보고서는, 날카로운 이빨을 벌리고 당신에게 뛰어오릅니다.]],
...
newEntity{ define_as = "SNAPROOT", -- backup guardian
	...
	desc = [[이 고대 트린트의 나무껍질은 거의 시커멓게 시들어 있습니다. 이것은 인간성을 정화되어야 할 재앙으로 여깁니다.]],
