...
newEntity{ define_as = "GREATER_MUMMY_LORD",
	...
	desc = [[이 미이라의 붕대는 그로부터 모든것을 밀어내는 것 같은 아주 강력한 힘을 뿜고 있습니다.]],
...
newEntity{ base = "BASE_NPC_MUMMY",
	...
	kr_display_name = "되살아난 미이라 붕대",
	desc = [[속이 텅빈 미이라 붕대로... 되살아난 존재입니다. 이동하지는 못하는 것 같습니다.]],
	level_range = {7, nil}, exp_worth = 1,
	rarity = 4,
