...
newEntity{ name = "Fryjia Loren",
	...
	display = "@",
	color=colors.VIOLET,
	desc = [[눈과 같이 창백한 피부를 가진 어린 소녀입니다. 그녀의 덩치는 작지만, 전투에서는 치명적인 얼음 파편의 탄막을 끊임없이 펼쳐내는 위협적인 적입니다.]],
...
newEntity{ name = "Riala Shalarak",
	kr_display_name = "리알라 샬라라크",
	define_as = "ARENA_BOSS_RIALA",
	type = "humanoid", subtype = "human",
	display = "@",
	color=colors.VIOLET,
	desc = [[강한 여성 마법사입니다. 여러 해 동안 겪은 경험은, 그녀를 위험한 전투원으로 만들었습니다.]],
...
newEntity{ name = "Valfren Loren",
	...
	desc = [[무거운 갑옷을 걸치고 무거운 도끼를 든, 강력한 저주에 걸린 인간입니다. 영원하 싸워야 하는 저주에 걸려 있습니다.]],
...
newEntity{ name = "Rej Arkatis",
	...
	desc = [[존경할 만한 기술을 가진 코르낙 투사입니다. 진정한 격투의 달인이 된 이후, 어디에서도 그의 모습을 찾아볼 수 없었습니다.]],
...
newEntity{ name = "rogue",
	...
	desc = [[속임수로 승리를 획득하려 하는 은밀한 투사입니다. 조심하지 않으면, 도적의 독에 시야를 잃게 될지도 모릅니다!]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 60,
	resolvers.equip{
