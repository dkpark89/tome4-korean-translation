...
newBirthDescriptor{
	...
	desc = {
		"전사는 여러가지 물리적 전투법을 수련합니다. 양손 대검을 휘두르는 파괴의 전차가 될 수도 있고, 번쩍이는 방패를 들고 온몸을 철갑옷으로 두른 기사가 될 수도 있습니다.",
	},
	descriptor_choices =
	{
		subclass =
...
newBirthDescriptor{
	type = "subclass",
	name = "Bulwark",
	kr_display_name = "기사 (Bulwark)",
	desc = {
		"기사는 다양한 방어기술을 구사하며, 무기와 방패를 이용한 전투에 특화되었습니다",
		"훌륭한 기사는 전방위에서 닥치는 무시무시한 공격을 방패로 견뎌낼 수 있으며, 반격의 기회가 오면 엄청난 힘으로 적에게 덤벼듭니다.",
...
newBirthDescriptor{
	...
	desc = {
		...
		"그들은 양손무기에 이를 적용하여, 그들이 가져올 완전한 파괴를 목표로 합니다.",
...
newBirthDescriptor{
	...
	desc = {
		"스펠블레이즈의 참상으로 인해 군대가 분산되어 많은 이들이 보호받지 못하게 되었으며, 무기를 구할 수 없었던 사람들도 많았습니다.",
		"그래서 가난한 이들은 자신의 몸을 지키기 위해, 무기에 의지하지 않고 육체를 단련하기 시작했습니다.",
		"지하 격투사나, 권투사, 혹은 그저 초보자라도, 격투가의 기술은 여전히 유용합니다.",
		"격투가의 다양한 능력으로 연계 점수를 얻어 마무리 기술을 강화하는데 쓸 수 있습니다.",
		"맨손 전투 방식은 움직이기 편하고 두 손이 비어있어야 하기 때문에, 판갑이나 무기, 방패를 장비한 채로 기술을 쓸 수 없습니다.",
