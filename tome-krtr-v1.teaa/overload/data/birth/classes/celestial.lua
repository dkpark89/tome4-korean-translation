...
newBirthDescriptor{
	...
	locked_desc = "천공의 마법은 극히 일부분의 지식만이 동대륙으로 전해졌고, 에이알에서는 잊혀졌습니다.",
	desc = {
		"천공의 사도들은 천공의 힘을 다루는데 초점을 맞춘 마법의 사용자입니다.",
...
newBirthDescriptor{
	...
	desc = {
		"태양의 기사는 동대륙 자유민의 최후의 보루인, '아침의 문(Gates of Morning)' 출신입니다.",
...
newBirthDescriptor{
	...
	locked_desc = "천공의 힘을 조율하는 것은 경외스런 일이다. 빛과 어둠을 뜻대로 다루며 황혼에 거하는 자들은 강대하다.",
	desc = {
		"아노리실은 동대륙 자유민의 최후의 보루인, '아침의 문(Gates of Morning)' 출신입니다.",
