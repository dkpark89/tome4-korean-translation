...
newTalent{
	...
	info = function(self, t)
		...
		피해량은 정신력의 영향을 받아 증가합니다.]]):format(dam, mast, spikecost, spikedam)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		피해량은 정신력의 영향을 받아 증가합니다.]]):format(dam, mast, spikecost, rad, spikedam)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		피해량은 정신력의 영향을 받아 증가합니다.]]):format(dam, mast, spikecost, nb, spikedam)
	end,
}
