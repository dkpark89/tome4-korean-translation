...
newTalent{
	...
	info = function(self, t)
		...
		나뉘어진 동안, 모든 저항력이 %d%% 상승합니다. (둘 모두에게 적용됩니다)
		저항력은 정신력 능력치의 영향을 받아 증가합니다.]]):
...
newTalent{
	...
	info = function(self, t)
		...
		자리를 바꾸는 동안 잠깐 합쳐져 6 턴 동안 적에게 주는 모든 자연과 산성 피해가 %d%% 증가하며, %d 생명력이 회복됩니다.
		피해량과 회복량은 정신력 능력치의 영향을 받아 증가합니다.]]):
