...
newTalent{
	...
	info = function(self, t)
		...
		기술 레벨 5 : 마법과 의지 능력치가 5 증가하고, 2 번 더 부활할 수 있습니다. 주문 내성과 정신 내성이 10 증가하며, 전체 저항력의 최대치가 10%% 증가합니다. 천공 / 별의 분노 계열을 (x0.9) 적성으로 사용할 수 있게 되며, 턴 당 음기 재생이 0.5 증가합니다.
		기술 레벨 6 : 마법과 의지 능력치가 6 증가하고, 3 번 더 부활할 수 있습니다. 주문 내성과 정신 내성이 15 증가하며, 전체 저항력의 최대치가 15%% 증가합니다. 천공 / 별의 분노 계열을 (x1.1) 적성으로 사용할 수 있게 되며, 턴 당 음기 재생이 1.0 증가합니다. 나의 힘 앞에 무릎 꿇으라!
