...
숨을 쉴수 없는 상황 일때만 호흡 수치가 나타납니다.
수치가 0에 도달하면 당신은 질식사하게 됩니다. 벽에 매몰되거나, 수중 등의 여러 상황에서 호흡 수치가 감소됩니다.
...
0에 가까울수록 평온한 상태를 의미합니다. 평온하지 못할수록 자연의 권능을 제대로 쓸 수 없게 됩니다.
]]
...
원혼 범위 내에서 당신이나 부하가 적을 살해하면 증가됩니다..
]]

TOOLTIP_FORTRESS_ENERGY = [[#GOLD#요새 에너지#LAST#
쉐르'툴 요새의 에너지입니다. 이것은 변환 상자로 물건을 바꿀때 보충되며, 모든 요새 시스템의 동력입니다.
]]
...
마법은 케릭터가 마력을 얼마나 잘 제어하는지를 나타냅니다. 주문력과 주문 내성, 그리고 다른 마법 물건의 효과를 상승시킵니다.
]]
...
방어도 관통력은 상대의 방어도를 일정량 무시하게 해줍니다(방어도에만 해당되며, 피해 저항에는 적용되지 않습니다).
방어도 관통력이 방어도를 0 밑으로 떨어뜨린다고 해도 피해량이 그만큼 증폭되는 것은 아니기에, 갑옷으로 무장한 적에게만 효과적입니다.
]]
