...
_M.miniboss = {
	{ name = "SKELERAT", wave = 4, entry = 2, display = "Skeletal rats", kr_display_name="해골 쥐들", score = 100, power = 5, rank = 0.1 },
	{ name = "GLADIATOR", wave = 2, entry = 1, display = "Gladiators", kr_display_name="검투사들", score = 150, power = 10, rank = 0.2 },
	{ nil },
	{ name = "GOLDCRYSTAL", wave = 4, entry = 3, display = "Golden crystals", kr_display_name="금빛 결정체들", score = 250, power = 15, rank = 0.1 },
	{ name = "MASTERSLINGER", wave = 3, entry = 2, display = "Master slingers", kr_display_name="숙련된 투석전사", score = 350, power = 20, rank = 0.2 },
	{ nil },
	{ name = "MASTERALCHEMIST", wave = 1, entry = 1, display = "Master Alchemist", kr_display_name="숙련된 연금술사", score = 400, power = 25, rank = 0.5 },
	{ name = "MULTIHUEWYRMIC", wave = 1, entry = 1, display = "Multi-hued Wyrmic", kr_display_name="다색의 용인", score = 400, power = 30, rank = 0.5 },
	{ nil },
	{ name = "REAVER", wave = 2, entry = 2, display = "Reaver", kr_display_name="파괴자", score = 800, power = 40, rank = 0.3 },
	{ name = "HEADLESSHORROR", wave = 1, entry = 1, display = "Headless horror", kr_display_name="머리 없는 공포", score = 1000, power = 50, rank = 1 },
}

_M.bosses = {
	{ name = "ARENA_BOSS_RYAL", display = "Ryal the Towering", kr_display_name="우뚝 선 리얄", chat = "arena_boss_ryal",
	score = 1500, power = 35,
	start = function ()
	...
	{ name = "ARENA_BOSS_FRYJIA", display = "Fryjia the Hailstorm", kr_display_name="우박의 프리지아", chat= "arena_boss_fryjia",
	score = 2500, power = 55,
	start = function ()
		local Chat = require "engine.Chat"
		local chat = Chat.new("arena", {name="Boss fight!", kr_display_name="보스 전투!"}, game.player)
	...
	{ name = "ARENA_BOSS_RIALA", display = "Riala the Crimson", kr_display_name="'핏빛'의 리알라", chat = "arena_boss_riala",
	score = 3500, power = 85,
	start = function ()
		local Chat = require "engine.Chat"
		local chat = Chat.new("arena", {name="Boss fight!", kr_display_name="보스 전투!"}, game.player)
	...
	{ name = "ARENA_BOSS_VALFREN", display = "Valfren the Rampage", kr_display_name="격노한 발프렌", chat = "arena_boss_valfren",
