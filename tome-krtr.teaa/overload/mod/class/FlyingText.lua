...
function _M:init(fontname, fontsize, bigfontname, bigfontsize)
	self.font = core.display.newFont(fontname or "/data/font/soya.ttf", fontsize or 12)
	self.bigfont = core.display.newFont(bigfontname or "/data/font/soya.ttf", bigfontsize or 14)
