...
newTalent{
	...
	info = function(self, t)
		...
		return ([[대상을 무기로 공격하여 %d%% 의 무기 피해를 준 뒤, 방패로 쳐서 %d%% 의 방패 피해를 줍니다. 방패 공격이 적중됐을 경우에, 찬란한 빛이 분출되어 %0.2f 의 빛 피해를 %d 타일 반경 내의 적들에게 주고 어두운 곳을 밝힙니다.
...
newTalent{
	...
	info = function(self, t)
		...
		return ([[당신이 받는 피해량의 절반을 흡수합니다. 응보로 %0.2f 의 피해를 흡수했을 때, 방패에서 찬란한 빛이 분출되어 %d 타일 반경에 흡수했던 피해량과 동일한 피해를 적들에게 준 뒤, 기술이 해제됩니다.
