...
newBirthDescriptor{
	...
	desc = {
		"무지, 탐욕, 어리석음으로 인해 저주받은 자들은 어둠의 세력을 섬겼었고, 이제 자신이 지은 죄의 대가로 파멸하였습니다.",
		"이제 모든 생명체에 대한 증오만이 유일한 주인입니다.",
		"그들과 마주친 자들의 죽음에서 끌어낸 힘으로, 저주받은 자들은 끔찍한 살육자가 됩니다.",
		"더 나쁜 사실은, 저주받은 자들에게 다가선 자는 누구라도 그 끔찍한 기운에 홀려 미쳐버린다는 것입니다.",
		"가장 중요한 능력치는 힘과 의지 입니다",
		"#GOLD#능력치 변경:",
...
newBirthDescriptor{
	...
	desc = {
		...
		"그들이 섬기던 어둠의 힘에 의해 마법을 빼앗긴 뒤로는, 마음 속에 불타오르는 증오심을 이용하는 방법을 배워야했습니다.",
		"새로운 길을 선택할 수 있을지, 아니면 영원히 파멸 당한 채로 남아있을지는 시간이 지나야 알 수 있을 것입니다.",
		"파멸한 자들은 어둠의 장막 뒤에 숨어 공격하거나 그림자의 주인이 될 수 있습니다.",
