...
그가 말하길 최고봉으로 가는 곳은 특수한 방법으로 보호되고 있다고 하더군요. 이 보호는 오크 긍지의 지배자들이 가지고 있는 "지배의 오브" 로 해제할 수 있다고 했습니다.
만약 지배의 오브를 가지고 있지 않다면, 다시 오크들의 서식지에 가서 찾아보세요.
그리고 그는 최고봉으로 가는 길이 "슬라임 굴"에 있다고 했습니다. 오크 서식지 중 어딘가, 아마 그루쉬낙 긍지가 있던 곳의 어딘가에 있다는군요.
]],
	answers = {
...
하지만 오크 긍지가 있는 곳 정도는 말해드릴 수 있을 것 같군요.
...
- 락'쇼르 긍지, 남쪽 사막 9 시 방향
- 고르뱃 긍지, 남쪽 사막에 있는 산 근처
- 보르 긍지, 북동쪽 지역
- 그루쉬낙 긍지, 최고봉의 동쪽 사면]],
...
당신이 해낸 모든 일에 감사드립니다. 이제 당신이 찾고자 하는 것을 위해 계속 노력해주세요.]],
	answers = {
		{"그들에게 복수를 해주겠습니다.", action=function(npc, player) 
		player:setQuestStatus("charred-scar", engine.Quest.DONE) 
		game:unlockBackground("aeryn", "High Sun Paladin Aeryn") end}
	},
}
