...
88 		- 매 턴마다 %0.2f 만큼의 생명력이 회복됩니다. 
89 		- 매 턴마다 %0.2f 만큼의 피해 보호막이 생성되며, 보호막의 피해량 감소 수치는 재충전됩니다. 이미 다른 피해 보호막이 발동 중일 경우에도 피해량 감소 수치가 재충전되며, 보호막의 남은 지속시간이 2 턴 미만일 경우 2 턴으로 고정됩니다. 하나의 피해 보호막을 20 회 이상 재충전시킬 경우, 보호막이 불안정해져 사라지게 됩니다. 
90 		- 치유 효과를 %d%% 증가시킵니다. 
91 		- 이 효과는 %d 턴 동안 지속되며, 해당 지역에 빛이 밝혀집니다. 
92 		회복량은 주문력의 영향을 받아 증가합니다.]]): 
