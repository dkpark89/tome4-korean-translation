...
64 		기술 레벨이 3 이상일 경우, 강렬한 빛이 대상과 주변 2 칸 반경의 모두를 %d 턴 동안 실명시키게 됩니다. 
65 		피해량은 주문력의 영향을 받아 증가합니다.]]): 
...
107 		또한 시전자는 태양의 길에 서있는 한, 이동할 때 시간이 소모되지 않고 함정을 발동시키지 않게 됩니다. 
108 		피해량은 주문력의 영향을 받아 증가합니다.]]):format(damDesc(self, DamageType.LIGHT, damage / 5), radius) 
	end,
}
...
143 		그리고 물리 혹은 주문 치명타를 발생시킬 때마다, %d%% 확률로 태양의 복수 효과가 2 턴 동안 발동됩니다. 
144 		태양의 복수 효과가 지속되는 동안에는, 태양 광선 기술을 사용할 때 시간이 소모되지 않으며 25%% 더 많은 피해를 입힐 수 있게 됩니다. 
145 		만약 태양 광선 기술이 재사용 대기 중일 경우, 기존 효과 대신 태양 광선의 재사용 대기 시간이 1 턴 줄어들게 됩니다. 
146 		이 효과는 한 턴에 1 번까지만 나타납니다.]]): 
		format(crit, chance)
	end,
}
...
179 		태양 망토 효과가 유지되는 동안, 주문 시전 속도는 %d%% 증가하며 주문의 재사용 대기 시간은 %d%% 감소합니다. 그리고 한번의 타격에 최대 생명력의 %d%% 이상은 절대 피해를 받지 않게 됩니다. 
180 		기술의 효과는 주문력의 영향을 받아 증가합니다.]]): 
