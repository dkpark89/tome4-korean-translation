...
uberTalent{
	...
	kr_name = "나의 무기가 되어라!",
	mode = "activated",
	require = { special={desc="신체 크기가 '큼' 이상일 것", fct=function(self) return self.size_category and self.size_category >= 4 end} },
	...
	info = function(self, t)
		...
		신체 크기가 '큼' 이상이라면, 크기가 한 단계 커질수록 피해량이 80%% 증가하게 됩니다.
...
uberTalent{
	...
	info = function(self, t)
		return ([[적에게 돌진 기술을 사용하면, 적에게 표식이 생깁니다. 표식은 2 턴 동안 유지되며, 표식이 생긴 적을 죽이면 돌진 기술의 재사용 대기시간이 사라져 다시 사용할 수 있게 됩니다.
		표식은 적에게 주는 피해를 20%% 증가시켜주는 효과도 있으며, 최대 100%% 까지 증가합니다.]])
		:format()
	end,
}
