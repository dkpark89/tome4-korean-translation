...
newTalent{
	...
	info = function(self, t)
		...
		:format(damDesc(self, DamageType.FIRE, self:combatTalentSpellDamage(t, 4, 90)), ((self:getTalentLevel(t) / 10))*100)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		피해량의 %d%% 만큼 대상도 피해를 입게 되며, 이 효과는 대상의 주변 2 칸 반경에 있는 모든 적들에게 적용됩니다.
