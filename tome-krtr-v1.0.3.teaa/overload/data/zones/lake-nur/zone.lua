...
--	all_lited = true,
	...
	on_enter = function(lev, old_lev, newzone)
		...
		elseif lev == 3 and not game.level.shown_warning and game.level.data.is_flooded then
			Dialog:simpleLongPopup("누르 호수", "As you descend to the next level you traverse a kind of magical barrier keeping the water away. The barrier seems to be failing however and the next level is flooded too.", 400) --@@ 한글화 필요
			game.level.shown_warning = true
		end
	end,
}
