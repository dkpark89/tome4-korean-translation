...
desc = function(self, who)
	local desc = {}
	desc[#desc+1] = "당신은 숨겨진 보물이 있는 곳으로 가기 위한 모든 단서를 찾았습니다. 이곳은 트롤 늪의 세 번째 지역을 통해 이곳에 갈 수 있습니다."
	desc[#desc+1] = "하지만, 이곳은 매우 위험한 곳으로 보입니다. 조심할 필요가 있습니다."
...
enter_level3 = function(self)
	...
	g.kr_name = "트롤 늪의 숨겨진 보물이 있는 곳으로 가는 길"
	g.desc = "조심하십시오!"
