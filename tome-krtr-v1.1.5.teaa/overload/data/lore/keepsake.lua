...
* 엄마는 다른 사람들처럼 죽은것 같지만 사람들은 그에 대해 말하기를 꺼려한다. 모든 시체가 불에 탄 듯하다.

* 테릭이 상단의 좋았던 날들에 대해 언급했다. 이득은 끝내줬고 평범한 강도나 도둑들도 없었다고 했다. 무엇이 그들을 무섭게 하는 걸까?

* 몇몇 죽은 자들은 '평범한' 상처를 가지고 있지만 몇몇은 단지 '생기가 없거나 창백할 뿐이다' 자크는 그렇게 발견되었다. 그게 2달 전 일이다.
...
newLore{
	...
	한때 당신이 몸 담았던 대상 행렬입니다. 오랜 시간동안 상단에 대해 생각하지 못했었지만, 지금 그들이 당신의 꿈에 나타났습니다.
...
newLore{
	...
	kr_name = "봉인된 동굴",
	always_pop = true,
	lore = [[동굴 입구는 봉인되있는듯 합니다.돌에는 이상한 표식과 문양들이 많이 새겨져있습니다.
...
그때 당신은 개에게 접근하는 바닥의 그림자를 눈치챘습니다. 동물은 고개를 들고 마치 누구의 말을 듣는 것처럼 행동합니다.
...
newLore{
	...
	이곳은 킬레스가 여행중에 모은 값어치 있는 것들을 보관하는 금고중에 하나입니다.
