...
function _M:getTextualDesc(compare_with, use_actor)
	...
	local desc_combat = function(combat, compare_with, field, add_table, is_fake_add)
		...
		compare_fields(combat, compare_with, field, "physspeed", function() return ("%.0f%%"):format(100/((is_fake_add and 1 or 0) + (combat.physspeed or 1))) end, "공격 속도    : ", 100, false, true, add_table)
