...
uberTalent{
	...
	info = function(self, t)
		return ([[기술이 활성화되면, 턴 소모 없이 이동할 수 있게 됩니다. 하지만 이를 위해서는 엄청난 체력이 소모되어, 1 칸 이동할 때마다 체력을 12 소모하게 됩니다.]])
		:format()
	end,
}
...
uberTalent{
	...
	info = function(self, t)
		...
		미생물 수치는 6 턴 동안 유지되며, 매 턴마다 그 효능이 10%% (최저 10) 씩 떨어집니다.
		상승되는 미생물 수치와 생명력 회복량은 체격 능력치와 최대 생명력의 영향을 받아 증가합니다.]]) --@@ 한글화 검수 필요 : 윗줄
...
uberTalent{
	...
	info = function(self, t)
		...
		맷집과 반응속도가 크게 증가하여 최대 생명력이 250, 회피도가 %d, 모든 내성이 %d 상승합니다.
