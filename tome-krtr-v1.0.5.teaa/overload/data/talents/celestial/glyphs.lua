...
newTalent{
	...
	info = function(self, t)
		...
		문양은 is a hidden trap (%d detection and %d disarm power based on your Magic) and %d 턴 동안 유지됩니다.]]):format(dazeduration, t.trapPower(self,t)*0.8, t.trapPower(self,t), duration) --@@ 한글화 필요
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		문양은 is a hidden trap (%d detection and %d disarm power based on your Magic) and %d 턴 동안 유지됩니다.
		피해량은 주문력의 영향을 받아 증가합니다.]]):
		format(damDesc(self, DamageType.SPELLKNOCKBACK, damage), t.trapPower(self, t)*0.8, t.trapPower(self, t), duration) --@@ 한글화 필요 : 두줄 위
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		빛의 폭발은 주변 1 칸 반경에 영향을 주며, 문양은 is a hidden trap (%d detection and %d disarm power based on your Magic) and %d 턴 동안 유지됩니다.
		피해량은 마법 능력치의 영향을 받아 증가합니다.]]):
		format(damDesc(self, DamageType.LIGHT, damage), t.trapPower(self, t)*0.8, t.trapPower(self, t)*0.8, duration) --@@ 한글화 필요 : 두줄 위
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		문양은 is a hidden trap (%d detection and %d disarm power based on your Magic) and %d 턴 동안 유지됩니다.]]):
		format(100 * slow, t.trapPower(self, t), t.trapPower(self, t), duration) --@@ 한글화 필요 : 한줄 위
	end,
}
