...
newEntity{ base = "BASE_STAFF", define_as = "TELOS_SPIRE",
	...
	use_power = { name = "turn into a corrupted losgoroth (poison, disease, cut and confusion immune; converts half damage into life drain; does not requrie breath", kr_name = "타락한 로스고로스로 변신 (중독과 질병, 출혈, 혼란에 완전 면역 & 공격시 피해량의 절반만큼 생명력 흡수 & 숨 쉴 필요 없어짐)", power = 30,
