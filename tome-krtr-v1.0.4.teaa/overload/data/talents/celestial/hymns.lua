...
newTalent{
	...
	activate = function(self, t)
		cancelHymns(self)
		game:playSoundNear(self, "talents/spell_generic")
		game.logSeen(self, "#DARK_GREY#그림자가 %s의 주변에서 춤을 추기 시작합니다!", (self.kr_name or self.name))
		return {
		}
	end,
	deactivate = function(self, t, p)
		game.logSeen(self, "#DARK_GREY#%s의 주변에서 춤 추던 그림자가 사라집니다.", (self.kr_name or self.name))
		return true
	end,
	info = function(self, t)
