...
uberTalent{
	...
	info = function(self, t)
		...
		신체 크기가 '큼' 이상이라면, 크기가 한 단계 커질수록 피해량이 추가로 80%% 증가하게 됩니다.
...
uberTalent{
	...
	info = function(self, t)
		return ([[슬라슐을 도와, 우클름스윅을 격퇴시켰습니다. 물 속에서 숨을 쉴 수 있게 되며, 삼지창을 포함한 각종 이형 무기들을 손쉽게 다룰 수 있게 됩니다. (이형 무기 수련 기술을 배우고, 기술 레벨이 5 증가합니다)
