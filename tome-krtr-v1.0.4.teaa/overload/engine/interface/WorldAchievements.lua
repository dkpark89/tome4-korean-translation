...
function _M:gainPersonalAchievement(silent, id, src, ...)
	...
	if not silent then
		...
		game.log("#"..color.."#새로운 업적 달성 : %s!", (a.kr_name or a.name))
		self:showAchievement("새로운 업적 달성 : #"..color.."#"..(a.kr_name or a.name), a)
...
function _M:gainAchievement(id, src, ...)
	...
	local color = a.huge and "GOLD" or "LIGHT_GREEN"
	game.log("#"..color.."#업적 달성 : %s!", (a.kr_name or a.name))
	self:showAchievement("업적 달성 : #"..color.."#"..(a.kr_name or a.name), a)
...
function _M:showAchievement(title, a)
	...
	local color = a.huge and "GOLD" or "LIGHT_GREEN"
		game:registerDialog(Achievement.new("업적 달성 : #"..color.."#"..(a.kr_name or a.name), a))
	end
end
