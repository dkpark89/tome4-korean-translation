...
function string.krTalentType(str)
	...
	elseif ori == "timetravel" then return "시간 여행"
	...
	elseif ori == "blade threading" then return "칼날의 흐름"
	elseif ori == "bow threading" then return "활의 흐름"
	elseif ori == "temporal guardian" then return "시간의 수호자"
	elseif ori == "threaded combat" then return "잘짜여진 전투기술"
	elseif ori == "temporal hounds" then return "시간의 사냥개"
	elseif ori == "flux" then return "흐름"
	elseif ori == "stasis" then return "정체"
	elseif ori == "spellbinding" then return "주문"
	elseif ori == "fate weaving" then return "운명의 실뜨기"
	-- corruptions
	...
	elseif ori == "called shots" then return "조준사격"
	-- cursed
	...
	elseif ori == "kinetic mastery" then return "수련 : 고급 동역학"
	elseif ori == "thermal mastery" then return "수련 : 고급 열역학"
	elseif ori == "charged mastery" then return "수련 : 고급 전기역학"
	...
	elseif ori == "tireless combatant" then return "끈질긴 병사"
...
function string.krRace(str)
	...
	elseif ori == "lich" then return "리치"
	elseif ori == "light" then return "빛"
	elseif ori == "living" then return "생명체"
	...
	elseif ori == "summoned" then return "소환수"
	...
	elseif ori == "unnatural" then return "비자연적 존재"
	elseif ori == "vampire" then return "흡혈귀"
...
function string.krKeywords(str)
	...
	elseif firstCh == 'd' then
		...
		elseif ori == "darkness" then return "어둠"
		elseif ori == "daylight" then return "햇빛"
		...
		elseif ori == "deflection" then return "편향"
