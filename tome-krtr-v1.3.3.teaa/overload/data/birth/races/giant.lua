...
시작하기 위해서는, 하플링들이 포탈에 손을 대었었던 장소를 살펴보는 게 좋을 것이다...]],
	desc = {
		"오우거는 인간의 변형 된 모습으로, 매혹의 시대에 콘클라베를 위해 일할 노동자나 전사로서 만들어졌습니다.",
		...
		"그들은 그들의 공격이 빗나가거나 막혔을 때 치명타 확률과 배율을 올려주고, 혼란과 기절에 대한 저항성을 부여하는 #GOLD#오우거의 분노#WHITE# 기술을 보유하고 있습니다.",
		"#GOLD#능력치 변화 :",
