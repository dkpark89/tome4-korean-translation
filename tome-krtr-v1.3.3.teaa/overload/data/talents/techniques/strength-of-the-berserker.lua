...
newTalent{
	...
	require = techs_req1,
	points = 5,
	message = function(self) if self.subtype == "rodent" then return "@Source@가 전투의 찍찍거림을 사용합니다." else return "@Source@가 전투 함성을 사용합니다." end end ,
	stamina = 30,
	cooldown = 18,
...
newTalent{
	...
	enable = function(self, t, p)
		...
		self:logCombat(self, "#Source#가 분노합니다!")
	end,
	...
	info = function(self, t)
		...
		분노를 유지하는 것은 몸에 부담이 되어 매 턴마다 생명력이 2%% 감소하게 되지만, 대신 이 기술로 인해 생명력을 1%% 잃을 때마다 치명타 확률이 0.5%% 상승하게 됩니다.		
