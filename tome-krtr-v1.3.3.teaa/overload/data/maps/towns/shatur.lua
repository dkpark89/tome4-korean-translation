...
quickEntity('@', {show_tooltip=true, name="Moss covered statue", kr_name = "ÀÌ³¢·Î µÚµ¤ÀÎ µ¿»ó", display='@', image="terrain/grass.png", add_displays = {mod.class.Grid.new{image="terrain/statue3.png"}}, color=colors.GREEN, block_move=function(self, x, y, e, act, couldpass) if e and e.player and act then game.party:learnLore("thaloren-lament") end return true end})
