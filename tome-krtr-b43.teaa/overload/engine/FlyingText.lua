...
function _M:init(fontname, fontsize, bigfontname, bigfontsize)
	self.font = core.display.newFont("/data/font/soya.ttf" or fontname or "/data/font/DroidSans.ttf", fontsize or 12)
	self.bigfont = core.display.newFont("/data/font/soya.ttf" or bigfontname or "/data/font/DroidSans-Bold.ttf", bigfontsize or 14)
