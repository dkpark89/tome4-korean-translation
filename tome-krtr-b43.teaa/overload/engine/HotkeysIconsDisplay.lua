...
function _M:init(actor, x, y, w, h, bgcolor, fontname, fontsize, icon_w, icon_h)
	...
	self.fontbig = core.display.newFont("/data/font/soya.ttf" or fontname or "/data/font/DroidSansMono.ttf", (fontsize or 10) * 2)
	...
	self.tiles = Tiles.new(icon_w, icon_h, "/data/font/soya.ttf" or fontname or "/data/font/DroidSansMono.ttf", fontsize or 10, true, true)
