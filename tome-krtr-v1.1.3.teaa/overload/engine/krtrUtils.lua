...
function string.krT_Reason(str)
	-- 관련내용 /engine/interface/ActorTalents.lua #482~531 canLearnTalent 함수의 두번째 반환 값 내용들
...
function string.krItemShortName(str)
	...
	-- 장비창에서의 짧은 아이템 설명에 사용. /mod/class/Object.lua #365번 줄에서 사용
	local ori = str:lower()
...
function string.krKeywords(str)
	...
	elseif firstCh == 'a' then
		...
		elseif ori == "anchoring" then return "고정"
	...
	elseif firstCh == 'b' then
		...
		elseif ori == "badger" then return "오소리"
		...
		elseif ori == "blighed" then return "황폐"
		elseif ori == "blight" then return "황폐"
	...
	elseif firstCh == 'c' then
		...
		elseif ori == "chaos" then return "혼돈"
		...
		elseif ori == "cunning" then return "교활함"
		elseif ori == "cureill" then return "질병치료"
		elseif ori == "curepoison" then return "중독치료"
		end
	elseif firstCh == 'd' then
		...
		elseif ori == "displacement" then return "왜곡"
	...
	elseif firstCh == 'e' then
		...
		elseif ori == "enchanted" then return "향상"
		...
		elseif ori == "etched" then return "피를새김"
	...
	elseif firstCh == 'f' then
		if ori == "faith" then return "신념"
		elseif ori == "fate" then return "숙명"
		...
		elseif ori == "fish" then return "물고기"
		...
		elseif ori == "forge" then return "연마"
	...
	elseif firstCh == 'g' then
		...
		elseif ori == "guard" then return "경비"
		elseif ori == "guardian" then return "수호자"
	...
	elseif firstCh == 'h' then
		...
		elseif ori == "healer" then return "치료사"
		...
		elseif ori == "hunt" then return "사냥"
		end
	elseif firstCh == 'i' then
		if ori == "icy" then return "냉기"
		elseif ori == "illuminate" then return "조명"
	...
	elseif firstCh == 'p' then
		...
		elseif ori == "protective" then return "보호하는"
		...
		elseif ori == "purifying" then return "정화"
	...
	elseif firstCh == 'r' then
		...
		elseif ori == "resistance" then return "저항력"
		elseif ori == "resonating" then return "공명"
		elseif ori == "restful" then return "편안함"
		elseif ori == "restorative" then return "회복"
		elseif ori == "retribution" then return "심판"
		elseif ori == "revealing" then return "감지"
	...
	elseif firstCh == 's' then
		...
		elseif ori == "stone" then return "돌"
		elseif ori == "storm" then return "폭풍"
		elseif ori == "stormlord" then return "폭풍군주"
	...
	elseif firstCh == 'w' then
		...
		elseif ori == "will" then return "의지"
		elseif ori == "willpower" then return "의지"
...
function string.krEffectType(str)
	...
	-- 상태 효과의 속성들. /mod/class/uiset/Minimalist.lua #1264, #1266, /mod/class/PalyerDisplay.lua #172, #174에서 사용
	local ori = str:lower()
