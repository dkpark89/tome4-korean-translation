...
function _M:newAchievement(t)
	...
	if not t.no_difficulty_duplicate then
		...
		t2.kr_name = (t2.kr_name or t2.name).." (탐사 모드)"
		...
		t2.kr_name = (t2.kr_name or t2.name).." (악몽 (모험) 난이도)"
		...
		t2.kr_name = (t2.kr_name or t2.name).." (악몽 (로그라이크) 난이도)"
		...
		t2.kr_name = (t2.kr_name or t2.name).." (정신나간 (모험) 난이도)"
		...
		local t2 = table.clone(t)
		t2.id = "INSANE_"..t2.id
		t2.kr_name = (t2.kr_name or t2.name).." (정신나간 (로그라이크) 난이도)"
		...
		t2.kr_name = (t2.kr_name or t2.name).." (미치광이 (모험) 난이도)"
		...
		t2.kr_name = (t2.kr_name or t2.name).." (미치광이 (로그라이크) 난이도)"
