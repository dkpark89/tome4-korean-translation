...
newEntity{ base = "DOWN", define_as = "ESCAPE_REKNOR", name="Escape route from Reknor", kr_name = "레크놀에서의 탈출로", change_zone="reknor-escape", change_level=3, change_zone_auto_stairs = true }
newEntity{ base = "DOWN", define_as = "DEEP_BELLOW", name="The Deep Bellow", kr_name = "깊은 울림", glow=true, change_zone="deep-bellow" }
