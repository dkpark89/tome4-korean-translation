...
newTalent{
	...
	info = function(self, t)
		...
		또한 시전자는 태양의 길에 서있는 한, 이동할 때 시간이 소모되지 않게 됩니다.
...
newTalent{
	...
	info = function(self, t)
		...
		태양의 분노 효과가 지속되는 동안에는, 태양 광선 기술을 사용할 때 시간이 소모되지 않으며 25%% 더 많은 피해를 입힐 수 있게 됩니다.
...
newTalent{
	...
	info = function(self, t)
		return ([[스스로를 태양빛 망토로 둘러싸, 6 턴 동안 마력을 강화시키고 몸을 보호합니다.
