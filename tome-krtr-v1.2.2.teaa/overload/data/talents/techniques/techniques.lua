...
newTalentType{ is_unarmed=true, allow_random=true, generic = true, type="technique/unarmed-training", name = "unarmed training", description = "판갑, 무기, 방패 어느 것도 사용하지 않는 비무장 상태에서의 전투 기술을 수련합니다." }
