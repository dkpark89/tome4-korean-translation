...
newBirthDescriptor{
	...
	locked_desc = "죽음의 힘, 무시무시한 의지, 이 육신은 멈추지 못하리라. 왕은 죽고, 지배자는 쓰러지나, 우리는 그들보다 오랫동안 존재하리라.",
	desc = {
...
newBirthDescriptor
{
	...
	locked_desc = "걸을 때는 느리게, 물어뜯을 때는 빠르게, 주인님께 배운 대로, 밤을 지배하리라!",
	desc = {
...
newBirthDescriptor
{
	...
	locked_desc = "진군하는 뼈의 군단, 걸음마다 덜그럭 덜그럭. 그러나 더는 섬기지 않으리, 우리는 싸움을 위해 진군하리라!",
	desc = {
