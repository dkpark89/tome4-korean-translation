...
소문에 의하면, 남쪽 산맥의 어딘가에 강력한 힘이 모인 장소가 있다고 합니다. 오래된 전설에서는 그 장소가 태양과 너무 가까이 있었기 때문에 하늘로 떨어진, 겨울빛 달의 일부분이 녹아있는 곳이라고 하더군요.
달이 떨어지면서 생긴 충격으로 인해, 주변에는 강이 생겼다고 합니다. 그리고 그 강의 물은 영겁의 시간 동안 달빛의 힘을 받아, 강력한 장비를 만들어낼 수 있다고 합니다.
그 강을 발견하게 되면, 이 두루마리로 저를 소환해주십시오. 그동안 저는 이 책에 써진 내용을 더 연구하고 있겠습니다. 당신의 소환을 기다리겠습니다.]],
	answers = {
