...
newChat{ id="has_material_gave_orb",
	text = [[아주 좋네. 자네가 그것들을 찾는 동안, 나는 모든 준비를 마쳤다네. 오, 이것을 받게. #LIGHT_GREEN#*그가 열쇠 하나를 건네줍니다.*#WHITE# 이 열쇠는 텔무르의 폐허를 여는데 쓰인다네. 오랜 세월 동안 봉인된 숄타르인이 있는 곳이지. 만약 그 폐허에서 "확률적 역장의 뒤집힘과 되돌아감" 이라는 제목의 글귀를 발견하게 되면, 그것을 가지고 와주게. 그러면 관문 이동에서 자네가 생존할 확률이 급격하게 올라가게 될 것이라네.]],
	answers = {
...
newChat{ id="orb_loan",
	text = [[걱정하지 말게. 며칠 뒤에 모든 준비를 끝내고 돌려주겠네. 오, 이것을 받게. #LIGHT_GREEN#*그가 열쇠 하나를 건네줍니다.*#WHITE# 이 열쇠는 텔무르의 폐허를 여는데 쓰인다네. 오랜 세월 동안 봉인된 숄타르인이 있는 곳이지. 만약 그 폐허에서 "확률적 역장의 뒤집힘과 되돌아감" 이라는 제목의 글귀를 발견하게 되면, 그것을 가지고 와주게. 그러면 관문 이동에서 자네가 생존할 확률이 급격하게 올라가게 될 것이라네.]],
	answers = {
		{"감사합니다. 그럼 이만.", action=function(npc, player) player:hasQuest("east-portal"):open_telmur(player) end},
	}
}
