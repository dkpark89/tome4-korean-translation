...
local function spare(npc, player)
	...
	game.logPlayer(player, "%s 그녀의 목걸이를 쥐더니, 마법 에너지로 화해 사라집니다.", (npc.kr_display_name or npc.name):capitalize():addJosa("이"))
end
...
newChat{ id="what",
	text = [[설마... 몰랐던거야?
네가 이곳에 들어간지 몇 시간 되지 않아, 오크 무리가 쳐들어왔지. 아니, 오크 뿐만이 아니었어. 악마들도 그 무리에 섞여있었지. 우리는 완전히 제압되었어! 완전히 파괴되었다구!
더 이상 내가 있을 곳은 없어! 이건 다 네가 검게 탄 상처에서 그들을 멈추지 못했기 때문이야! 너 때문에 우리는 실패했어! 너를 보호하기 위해 사람들이 죽었지만, 너는 실패했다구!
