...
newLore{
	...
	kr_display_name = "사령술사가 되는 방법, 1부",
	lore = [[#{bold}#1. 영광된 기술#{normal}#

당신이 속한곳에서의 같잖은 허세는 다 쫓아내셨나요? 당신의 영혼이 진정한 힘을 갈구하고 있나요? 가장 위력적인 죽음을 스스로 거스를 수 있는 힘을 갖기를 원하신가요? 사령술의 영광된 기술이 당신이 상상도 못할 방법으로 소원을 이루어 드립니다.
...
newLore{
	...
	kr_display_name = "사령술사가 되는 방법, 2부",
	lore = [[#{italic}#2. 죽음을 지배하라#{normal}#

수집한 표본들에다가 생명을 불어넣을때 많은 논란거리가 생기곤 합니다. 표본들을 생명이 없는 꼭두각시로 만들것인가요 아니면 사망한 자의 영혼을 다시 한번 그릇에 묶어둘 생각인가요? 사령술사들의 다양한 활동만큼이나 의견 충돌이 많습니다. 사령술의 해부학파는 감금된 영혼을 고문하는 것을 본바탕에 깔고 그것을 최고로 여깁니다. 붙잡힌 영혼이 만들어내는 분노가 언데드 노예를 더욱 더 효과적으로 만든다고 주장합니다. 그렇지만 최근에 성립된 정신학파는 이 같은 주장에 반대합니다. 붙잡힌 영혼을 자유롭게 해주는 것은 자신들의 주인을 죽이고자 하는 의지가 덜한 잘 복종하는 노예를 만드는 호과를 가져다 준다고 주장합니다. 그뿐만 아니라 작업 방식이 조금 더러워지더라도 용납할 수 있게 됩니다. 물론 기회만 된다면 하인들은 주인을 공격하고 마을로 질질 끌고가 불태워버릴테지만, 그 때가 되면 주인에 대한 애증을 느낄 겁니다. 제기랄!

기억하세요. 부하의 의지를 조종하기 위해 룬의 회로를 활용할때, 사전에 회로의 모든 룬이 제대로 부여되었는지, 흐지부지 될 위험이 있지는 않은지 확인해야 합니다. 만약에 예상치 못한 일이 생겨 군단 속에 자유를 되찾은 자가 생겨나면, 당신 목숨 값으로 물건들이나 장비를 제공하는게 좋습니다. 그런 자비로운 행동 후에도 주인을 죽이는 언데드는 소수입니다.]]
}
...
newLore{
	...
	kr_display_name = "사령술사가 되는 방법, 3부",
	lore = [[#{italic}#3. Unwanted Attention#{normal}#


슬프게도 우리의 작업을 탐탁찮아 하는 이들은 소작농이랑 우리의 "고결하신" 사촌 마도사들 뿐만이 아닙니다. 사령술에 대한 무지로, 사령술은 많은 차원을 뛰어넘는 종류의 "파문"을 만든다 알려져 있습니다. 다른 차원의 관심을 끄는 종류의 파문을 말입니다. 사령술사의 힘이 강해짐에 따라 마침내 사령술사가 악마적인 힘을 사용하는 모든 방법을 깨달아 육체적, 정신적 한계를 뛰어넘게 된다면 진정한 파문이 뭔지 알게 될것입니다.

다시 한번 말하지만, 악마의 간섭에 대한 의견은 갈립니다. 사령술은 아름답고 우아한 예술입니다 그렇지 않습니까? 정신학파는 외부 영향에 의한 사령술사의 타락을 부정적으로 지켜봅니다. 그리고 그런 학파 전문가들은 초자연적인 관심을 피하기 위한 수단으로 영적인 "안내자" 역할을 하는 부적을 만들거나 사령술사가 내뿜는 어두운 기운을 숨기기 위한 목적으로 많은 생명력이 살아숨쉬는 공동체 근처에서 생활합니다. 반면에 해부학파들은 악마의 영역에서 속삭여오는 저주의 목소리를 기꺼이 받아들이고 그 속삭임을 정신의 완성이라고 믿습니다. 일단 영혼이 한번 "오염"(해부학파 전문가들이 비웃는 용어입니다)되었다면 사람들은 자신의 진정한 야망을 깨달을 수 있다고 주장합니다. 왜 "진정한 야망"이 항상 세상에 모든 살아숨쉬는 생명체들의 완전한 파괴와 생각할 수 없이 잔혹한 것들을 외부 차원에서 소환하는 것인지에 대한 설명은 되어 있지 않습니다.
...
newLore{
	...
	kr_display_name = "사령술사가 되는 방법, 4부",
	lore = [[#{italic}#4. 마즈'에이알의 사령술사들#{normal}#

사령술사의 가장 위험한 적은 바로 다른 다른 사령술사입니다. 물론, 지구르 추종자들, 왕국연합, 샬로레, 탈로레, 철의 왕좌, 마을의 민간인들, 언데드 사냥꾼들, 모험가, 언데드 강도, 리나니일을 제외하면 말이죠. 그들을 다 제외하면 가장 큰 적은 바로 다른 사령술사들 입니다. 아래 적혀있는 것들이 바로 평균 이상의 언데드 활동지역을 점령중인 주의할만한 사령술사들의 위치와 우리에게 부적합한 위치입니다. 우리 분야의 신예들은 이 지역에서 멀리 떨어진 곳에서 작업하길 강하게 권장합니다. 그래야만 그 사람들이 덜 위협적으로 인지하고, 나중에 크게 될수 있으니까요.

#{italic}#코르'풀의 폐허#{normal}#: 오래된 사령술사 코르풀이 사라졌지만, 그의 그림자가 남긴 흔적은 오래도록 남아 정상적인 부분은 흔적조차 찾을 수 없습니다. 그의 보금자리는 어두운 에너지의 원천이 되었고 그의 부하들은 군단으로 남아있습니다.

#{italic}#황폐화된 폐허#{normal}#: 야망에 가득찬 초보 사령술사가 막을 수 없는 죽음의 군대를 만들기 위해 꿈을 쫓아 이 폐허에 자리 잡았습니다. 그의 방식은 거칠고 실패에 가까워서,저는 몇년 안에 자신이 만든 작업물의 손에 사라지는 소리를 듣길 기대하고 있습니다.

#{italic}#두려움의 영역#{normal}#: 언데드들이 버려진 탑에 셀 수 없이 많이 모여있습니다. 명백하게, 강력한 존재가 집으로 삼은게 분명합니다. 그렇지만 이 탑의 주인이 누구인지는 전혀 알 길이 없습니다.

#{italic}#데르스#{normal}#: 여기 지루한 시골 마을에 제대로 된 사령술사의 존재가 없음에도 불구하고 그 지역에 우리 분야의 전분가들이 일을 하기가 불가능했습니다. 왜 그런지에 대한 소문에 의하면 모든 주민들이 이미 언데드이고 기만의 망토를 두르고 있다는 이야기까지 나오고, 정신학파의 숨은 본거지라는 말도 있습니다. 이유야 어쨌든간에 조심하세요.

#{italic}#지구르#{normal}#: 적의 적은 아군이라는 말은 이 상황에서는 통하지 않습니다. "평범한" 마법의 존재가 지구르에 살고 있는 정신 나간 광신도를 보낼 이유가 된다면 - 사령술사의 존재는 제 2의 장작더미의 시대를 불러일으키기에 충분하니까요!
...
그러나 여자들은 남자들을 보며 멍청이라고 합니다 "어떻게," 그녀들이 말합니다, "하플링의 발이 신발이나 멋진 공예품을 신을 수도 없는데 어째서 행운의 상징이 된다는 거죠? 그리고 특히 하플링들에게는 큰 불행이잖아요. 하플링들 키가 그렇게 작아서 굽있는 것들을 신어야 하니 말이에요..."
