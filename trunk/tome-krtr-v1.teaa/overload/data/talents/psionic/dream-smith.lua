...
newTalent{
	...
	info = function(self, t)
		...
		return ([[꿈의 망치를 던져, 망치의 이동 경로에 있는 모든 적들에게 %d%% 무기 피해를 줍니다. 목표 지점까지 날아간 뒤에, 망치가 돌아오면서 적들을 한 번 더 공격할 수도 있습니다.
		그리고, 꿈의 망치의 정확도가 %d 상승하게 됩니다.]]):format(damage * 100, attack_bonus)
	end,
}

newTalent{
	name = "Dream Crusher",
	kr_display_name = "꿈 분쇄기",
