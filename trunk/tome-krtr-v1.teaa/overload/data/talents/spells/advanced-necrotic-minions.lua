...
local minions_list = {
	...
	h_bone_giant = {
		...
		kr_display_name = "무거운 뼈거인",
		desc = [[수백 개의 시체를 쌓아 만들어진 언데드입니다. 부정한 기운이 흐르고 있습니다.]],
