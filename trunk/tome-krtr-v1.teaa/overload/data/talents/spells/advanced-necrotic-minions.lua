...
newTalent{
	...
	info = function(self, t)
		...
		선택된 언데드 추종자를 자폭시켜, 언데드 추종자가 지녔던 최대 생명력의 %d%% 에 해당하는 황폐 속성 피해를 주변에 줍니다.
		부하의 자폭에 휘말리는 멍청한 주인이 아니길 빕니다.]]):
...
newTalent{
	...
	info = function(self, t)
		return ([[부하 스켈레톤 셋을 결합시켜, 해골 거인을 만들어냅니다.
