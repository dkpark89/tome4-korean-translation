...
newTalent{
	...
	info = function(self, t)
		...
		대상이 출혈에 걸리면, 피냄새를 맡은 자신을 포함한 주변의 '포식자' 들이 광란 상태에 빠집니다.]]):format(damage, bleed)
	end,
}
