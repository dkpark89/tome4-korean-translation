...
newTalent{
	...
	info = function(self, t)
		...
		피해량은 주문력 능력치의 영향을 받아 증가합니다.]]):format(damDesc(self, DamageType.BLIGHT, self:combatTalentSpellDamage(t, 20, 250)), self:getTalentLevel(t) * 5)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		저항 감소량은 주문력 능력치의 영향을 받아 증가합니다.]]):format(3 + self:getTalentLevel(t), self:combatTalentSpellDamage(t, 10, 45))
	end,
}
...
newTalent{
	...
	action = function(self, t)
		...
		self:project(tg, x, y, function(px, py)
			...
			if not target:canBe("teleport") then game.logSeen("%s 어둠의 문에 끌려가지 않았습니다!") return end
	...
	info = function(self, t)
		...
		피해량은 주문력 능력치의 영향을 받아 증가합니다.]]):format(damDesc(self, DamageType.BLIGHT, self:combatTalentSpellDamage(t, 12, 80)), self:combatTalentSpellDamage(t, 5, 25))
	end,
}
