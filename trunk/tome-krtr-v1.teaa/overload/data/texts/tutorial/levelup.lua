...
return [[ToME4 에서, 캐릭터의 강함은 그/그녀의 레벨로 구분합니다. 플레이어는 캐릭터를 50 레벨까지 키울 수 있습니다.
...
* #GOLD#기술 계열 점수#WHITE# : 새로운 기술 계열을 배우거나, 현재 배운 기술 계열의 적성을 높이고자 할 때 사용합니다. 10 레벨, 20 레벨, 30 레벨에 1 점씩 얻습니다.
