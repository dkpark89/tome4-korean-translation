...
newEntity{ base = "BASE_RING",
	...
	kr_display_name = "바르그 구원", kr_unided_name = "바닷빛 반지",
...
newEntity{ base = "BASE_LEATHER_BOOT",
	...
	desc = [[문제를 해결하는 최고의 방법이 도망이라는 것을 알던 추방된 도둑의 신발입니다.]],
...
newEntity{ base = "BASE_SHIELD",
	...
	kr_display_name = "검은 직물", kr_unided_name = "덩굴 덩어리",
	desc = [[덩굴을 엮어 만든 이 검은 직물은 방패로 사용할 수 있습니다. 이것은 건드리면 팔에 들러붙고 흥분하여 삼키려하는 반응읍 보입니다.]],
	color = colors.BLACK,
	level_range = {15, 30},
	rarity = 270,
	...
	on_block = function(self, who, src, type, dam, eff)
		if rng.percent(30) then
			...
			game.logSeen(src, "검은 덩굴이 뻗어나가 %s 당깁니다!", (src.kr_display_name or src.name):capitalize():addJosa("를"))
...
newEntity{ base = "BASE_LIGHT_ARMOR",
	...
	desc = [[이 갑옷을 입은 어떤 도둑도 무능하지 않았습니다.]],
	level_range = {25, 40},
	rarity = 270,
	cost = 200,
	require = { stat = { str=22 }, },
