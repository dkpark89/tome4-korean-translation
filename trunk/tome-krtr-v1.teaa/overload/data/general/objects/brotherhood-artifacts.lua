...
newEntity{
	...
	use_simple = { name="permanently increase your dexterity and cunning by three", kr_display_name="민첩과 교활함 능력치가 각각 3 씩 영구적으로 증가", use = function(self, who)
...
newEntity{
	...
	use_simple = { name="permanently increase your defense and ranged defense by six", kr_display_name="회피도와 장거리 회피도가 각각 6 씩 영구적으로 증가", use = function(self, who)
		game.logPlayer(who, "#00FFFF#당신은 엘릭서를 마셨습니다. 신체가 영구적으로 변화되었습니다!")
...
newEntity{
	...
	use_simple = { name="permanently increase all your saving throws by 4", kr_display_name="모든 내성을 각각 4 씩 영구적으로 증가", use = function(self, who)
		game.logPlayer(who, "#00FFFF#당신은 엘릭서를 마셨습니다. 신체가 영구적으로 변화되었습니다!")
...
newEntity{
	...
	use_simple = { name="grant you four additional stat points", kr_display_name="능력치 점수 4 점 부여", use = function(self, who)
		game.logPlayer(who, "#00FFFF#당신은 엘릭서를 마셨습니다. 신체가 영구적으로 변화되었습니다!")
...
newEntity{
	...
	kr_display_name = "폭발력의 엘릭서", kr_unided_name = "주황색의 액체가 든 약병",
	...
	use_simple = { name="permanently increase your chance to critically strike with spells by 4%", kr_display_name="주문 치명타율이 영구적으로 4% 증가", use = function(self, who)
		game.logPlayer(who, "#00FFFF#당신은 엘릭서를 마셨습니다. 신체가 영구적으로 변화되었습니다!")
...
newEntity{
	...
	desc = [[생생한 노란색 액체가 든 약병입니다.]],
	no_unique_lore = true,
	cost = 1000,
	quest = 1,

	use_simple = { name="permanently increase your luck by 5", kr_display_name="행운이 영구적으로 5 상승", use = function(self, who)
		game.logPlayer(who, "#00FFFF#당신은 엘릭서를 마셨습니다. 신체가 영구적으로 변화되었습니다!")
...
newEntity{
	...
	use_simple = { name="grant you two additional class talent points", kr_display_name="직업 기술점수 2 점 부여", use = function(self, who)
		game.logPlayer(who, "#00FFFF#당신은 엘릭서를 마셨습니다. 신체가 영구적으로 변화되었습니다!")
...
newEntity{
	...
	use_simple = { name="permanently increase your strength and constitution by three", kr_display_name="힘과 체격 능력치가 각각 3 씩 영구적으로 증가", use = function(self, who)
		game.logPlayer(who, "#00FFFF#당신은 엘릭서를 마셨습니다. 신체가 영구적으로 변화되었습니다!")
...
newEntity{
	...
	use_simple = { name="permanently increase your armor by four", kr_display_name="방어도가 영구적으로 4 상승", use = function(self, who)
		game.logPlayer(who, "#00FFFF#당신은 엘릭서를 마셨습니다. 신체가 영구적으로 변화되었습니다!")
...
newEntity{
	...
	use_simple = { name="grant you two additional generic talent points", kr_display_name="일반 기술점수 2 점 부여", use = function(self, who)
		game.logPlayer(who, "#00FFFF#당신은 엘릭서를 마셨습니다. 신체가 영구적으로 변화되었습니다!")
...
newEntity{ base = "BASE_GEM",
	...
	kr_display_name = "생명력이 묶인 에메랄드", kr_unided_name = "흐릿하고 무거운 에메랄드",
...
newEntity{
	...
	use_simple = { name="grant you complete invulnerability for five turns", kr_display_name="5 턴 동안 절대적인 불사의 상태 부여", use = function(self, who)
