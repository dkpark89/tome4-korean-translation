...
newEntity{ define_as = "ORB_UNDEATH",
	...
	kr_display_name = "언데드의 오브 (지배의 오브)", kr_unided_name = "지배의 오브",
	level_range = {50, 50},
...
newEntity{ define_as = "ORB_DRAGON",
	...
	kr_display_name = "드래곤 오브 (지배의 오브)", kr_unided_name = "지배의 오브",
	level_range = {50, 50},
...
newEntity{ define_as = "ORB_ELEMENTS",
	...
	kr_display_name = "엘리먼트 오브 (지배의 오브)", kr_unided_name = "지배의 오브",
	level_range = {50, 50},
