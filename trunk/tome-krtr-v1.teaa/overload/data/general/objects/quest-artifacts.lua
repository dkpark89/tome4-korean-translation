...
newEntity{ define_as = "STAFF_ABSORPTION",
	...
	kr_display_name = "흡수의 지팡이", kr_unided_name = "어두운 룬이 새겨진 지팡이",
...
주변의 빛을 흡수하는 것 같으며, 살짝만 건드려봐도 이 지팡이 안에 엄청난 힘이 잠재된 것을 느낄 수 있습니다.]],
	...
	use_power = { name = "absorb energies", kr_display_name = "에너지 흡수", power = 1000,
...
newEntity{ define_as = "ORB_ELEMENTS",
	...
	kr_display_name = "정령의 오브 (지배의 오브)", kr_unided_name = "지배의 오브",
	level_range = {50, 50},
...
newEntity{ define_as = "ORB_SCRYING",
	...
	plot = true, quest = true,
	save_hotkey = true,
	desc = [[이 오브는 하플링 점술사 엘리사에게 받은 것입니다. 이것은 자동으로 일반적인 물건이나 희귀한 물건을 감정해 줍니다. 매우 희귀한 물건을 감정하기 위해서는 오브를 사용하여 엘리사와 연락을 취해야 한다고 합니다.]],
