...
newEntity{ base = "BASE_RING",
	...
	kr_display_name = "구리 반지",
	unided_name = "copper ring", short_name = "copper",
	kr_unided_name = "구리 반지",
	level_range = {1, 10},
	cost = 1,
	material_level = 1,
}
newEntity{ base = "BASE_RING",
	...
	kr_display_name = "강철 반지",
	unided_name = "steel ring", short_name = "steel",
	kr_unided_name = "강철 반지",
	level_range = {10, 20},
	cost = 2,
	material_level = 2,
}
newEntity{ base = "BASE_RING",
	...
	kr_display_name = "황금 반지",
	unided_name = "gold ring", short_name = "gold",
	kr_unided_name = "황금 반지",
	level_range = {20, 30},
	cost = 5,
	material_level = 3,
}
newEntity{ base = "BASE_RING",
	...
	kr_display_name = "스트라라이트 반지",
	unided_name = "stralite ring", short_name = "stralite",
	kr_unided_name = "스트라라이트 반지",
	level_range = {30, 40},
	cost = 10,
	material_level = 4,
}
newEntity{ base = "BASE_RING",
	...
	kr_display_name = "보라툰 반지",
	unided_name = "voratun ring", short_name = "voratun",
	kr_unided_name = "보라툰 반지",
	level_range = {40, 50},
	cost = 15,
	material_level = 5,
}
...
newEntity{ base = "BASE_AMULET",
	...
	kr_display_name = "구리 목걸이",
	unided_name = "copper amulet", short_name = "copper",
	kr_unided_name = "구리 목걸이",
	level_range = {1, 10},
	cost = 1,
	material_level = 1,
}
newEntity{ base = "BASE_AMULET",
	...
	kr_display_name = "강철 목걸이",
	unided_name = "steel amulet", short_name = "steel",
	kr_unided_name = "강철 목걸이",
	level_range = {10, 20},
	cost = 2,
	material_level = 2,
}
newEntity{ base = "BASE_AMULET",
	...
	kr_display_name = "황금 목걸이",
	unided_name = "gold amulet", short_name = "gold",
	kr_unided_name = "황금 목걸이",
	level_range = {20, 30},
	cost = 5,
	material_level = 3,
}
newEntity{ base = "BASE_AMULET",
	...
	kr_display_name = "스트라라이트 목걸이",
	unided_name = "stralite amulet", short_name = "stralite",
	kr_unided_name = "스트라라이트 목걸이",
	level_range = {30, 40},
	cost = 10,
	material_level = 4,
}
newEntity{ base = "BASE_AMULET",
	...
	kr_display_name = "보라툰 목걸이",
	unided_name = "voratun amulet", short_name = "voratun",
	kr_unided_name = "보라툰 목걸이",
	level_range = {40, 50},
	cost = 15,
	material_level = 5,
}
