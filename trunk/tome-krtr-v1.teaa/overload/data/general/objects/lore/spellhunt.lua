...
newEntity{ base = "BASE_LORE_RANDOM",
	...
	kr_display_name = "마법사냥꾼을 위한 안내서 1 : 주문 사용자 구별법",
	desc = [[마법 사용자를 사냥하는 확실한 방법이 적힌 안내서입니다.]],
	level_range = {1, 25},
	rarity = 40,
	encumber = 0,
}
newEntity{ base = "BASE_LORE_RANDOM",
	...
	kr_display_name = "마법사냥꾼을 위한 안내서 2 : 주문 사용자와 싸우는 법",
	desc = [[마법 사용자를 사냥하는 확실한 방법이 적힌 안내서입니다.]],
	level_range = {1, 25},
	rarity = 40,
	encumber = 0,
...
newEntity{ base = "BASE_LORE_RANDOM",
	...
	kr_display_name = "마법사냥꾼을 위한 안내서 3 : 주문 사용자를 죽이는 법",
	desc = [[마법 사용자를 사냥하는 확실한 방법이 적힌 안내서입니다.]],
	level_range = {1, 25},
	rarity = 40,
	encumber = 0,
