...
newEntity{
	...
	resolvers.charm("다음 6 턴 동안, 최대 %d 개의 나쁜 정신적 상태효과를 방어", 20, function(self, who)
...
newEntity{
	...
	kr_display_name = "염동력 폭발의 ",
	keywords = {mindblast=true},
	level_range = {15, 50},
	rarity = 8,

	charm_power_def = {add=45, max=300, floor=true},
	resolvers.charm(function(self) return ("염동력을 모아서, 관통하는 화살 형태로 발사 (%d - %d 피해)"):format(self:getCharmPower()/2, self:getCharmPower()) end, 6, function(self, who)
