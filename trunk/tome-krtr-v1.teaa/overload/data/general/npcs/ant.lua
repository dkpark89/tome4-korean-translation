...
newEntity{ base = "BASE_NPC_ANT",
	...
	kr_display_name = "거대 왕개미",
	desc = "큰 턱이 달린, 거대한 검은 개미입니다.",
...
newEntity{ base = "BASE_NPC_ANT",
	...
	kr_display_name = "거대 불개미",
	desc = "붉게 타오르고 있는, 커다란 붉은 개미입니다.",
...
newEntity{ base = "BASE_NPC_ANT",
	...
	kr_display_name = "거대 얼음 개미",
	desc = "주변의 공기를 얼리고 있는, 커다란 흰 개미입니다.",
	level_range = {15, nil}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(20,40),
...
newEntity{ base = "BASE_NPC_ANT",
	...
	kr_display_name = "거대 번개 개미",
	desc = "몸통에서 전기가 흐르고 있는, 커다란 노란 개미입니다.",
	level_range = {15, nil}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(20,40),
	combat = { damtype=DamageType.LIGHTNING },
...
newEntity{ base = "BASE_NPC_ANT",
	...
	kr_display_name = "거대 산성 개미",
	desc = "커다란 검은 개미입니다. 구멍 투성이의 피부에서 산성 점액질이 흐르고 있습니다.",
	level_range = {15, nil}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(20,40),
	combat = { damtype=DamageType.ACID },
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = "전투를 위해 단단한 외골격이 진화한, 커다란 개미입니다.",
