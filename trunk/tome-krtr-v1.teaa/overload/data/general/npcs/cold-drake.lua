...
newEntity{ base = "BASE_NPC_COLD_DRAKE", define_as = "NPC_COLD_DRAKE",
	...
	kr_display_name = "냉기 드레이크",
	desc = [[성숙한 냉기 드레이크입니다. 험악하게 생긴 발톱을 가졌으며, 치명적인 브레스를 뿜어낼 수 있습니다.]],
...
newEntity{ base = "BASE_NPC_COLD_DRAKE",
	...
	kr_display_name = "냉기 용",
	desc = [[오랜 세월을 살아온 강력한 냉기 드레이크입니다. 험악하게 생긴 발톱을 가졌으며, 치명적인 브레스를 뿜어낼 수 있습니다.]],
