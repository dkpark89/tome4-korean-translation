...
newEntity{ base = "BASE_NPC_BEAR",
	...
	kr_display_name = "동굴 곰",
	desc = [[먹이를 찾아 동굴에서 내려온 놈입니다. 불행히도 당신을 찾은것 같습니다.]],
...
newEntity{ base = "BASE_NPC_BEAR",
	...
	kr_display_name = "전투 곰",
	desc = [[엄미로 적을 죽이는 훈련이 된 곰입니다.]],
	level_range = {7, nil}, exp_worth = 1,
	rarity = 3,
