...
newEntity{ base = "BASE_NPC_STORM_DRAKE",
	...
	kr_display_name = "폭풍 드레이크",
	desc = [[성숙한 폭풍 드레이크입니다. 치명적인 브레스를 사용할 수 있고 험악한 발톱을 가졌습니다.]],
...
newEntity{ base = "BASE_NPC_STORM_DRAKE",
	...
	kr_display_name = "폭풍 이무기",
	desc = [[늙고 강력한 폭풍 드레이크입니다. 치명적인 브레스를 사용할 수 있고 험악한 발톱을 가졌습니다.]],
