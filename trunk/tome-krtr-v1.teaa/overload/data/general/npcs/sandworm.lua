...
newEntity{ base = "BASE_NPC_SANDWORM",
	name = "sandworm",
	kr_display_name = "지렁이",
	desc = [[모래 속에서 살고 그 색깔을 닮은 거대한 벌레입니다. 당신이 그 굴에 있는 것을 별로 좋아하지 않는 것 같습니다.]],
	rarity = 1,
}

newEntity{ base = "BASE_NPC_SANDWORM",
	name = "sandworm destroyer",
	kr_display_name = "파괴자 지렁이",
	color={r=169,g=168,b=52},
	desc = [[모래 속에서 살고 그 색깔을 닮은 거대한 벌레입니다. 이 특별한 지렁이는 한가지 목적만을 위해 길러졌습니다. 그 목적은 지렁이가 아닌 모든 존재를 없애는 것입니다. 물론 여기에는 당신도 포함됩니다.]],
	rarity = 3,
...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	kr_display_name = "모래 드레이크",
	type = "dragon", subtype = "sand",
	color={r=204,g=255,b=95},
	desc = [[날개없는 용처럼 생긴 부정한 생물입니다. 그러나 지렁이와 비슷한 색깔을 가지고 있습니다.]],
	rarity = 5,
	rank = 3,
	size_category = 5,
...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	desc = "땅이 흔들리면서 이 거대한 벌레가 당신쪽으로 굴을 파고 있습니다. 그 거대한 입은 돌과 같이 살점도 먹어치울 수 있습니다.",
...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	desc = "이 거대한 벌레는 강력한 부식성 타액을 사용하여 땅 속에서 굴을 파고 돌아다닙니다.",
	level_range = {20, nil}, exp_worth = 1,
	rarity = 3,
	size_category = 4,
	...
	on_die = function(self, src)
		...
		game.logSeen(self, "%s 산성 구름에 갖혀 폭발합니다.", (self.kr_display_name or self.name):capitalize():addJosa("가"))
	end,
}
