...
newEntity{ base = "BASE_NPC_CANINE",
	...
	kr_display_name = "늑대",
	desc = [[말랐고 음흉하며 털이 수북합니다. 배고픈 눈빛으로 당신을 쳐다봅니다.]],
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	kr_display_name = "대형 늑대",
	desc = [[보통의 늑대보다 더 커다랗습니다. 당신의 주변을 맴돌다 달려듭니다.]],
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	kr_display_name = "이리",
	desc = [[말만큼 커다란 이 늑대는 그 발톱과 이빨로 당신을 위협합니다.]],
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	kr_display_name = "흰 늑대",
	desc = [[북쪽 황무지에서 온 크고 근육질의 늑대입니다. 냉기 섞인 차가운 숨을 쉬고, 털에는 서리가 맺혀 있습니다.]],
	level_range = {4, nil}, exp_worth = 1,
	rarity = 3,
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	kr_display_name = "여우",
	desc = [[빠른 갈색 여우가 게으른 개를 뛰어 넘는다 (The quick brown fox jumps over the lazy dog).]], --@@ 이스터애그 같은데, 모든 알파벳 글자가 다 들어가는 문장으로, 글꼴 모양을 볼때 사용하는 문장입니다.
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	kr_display_name = "타이탄 와르그 룬고프",
	desc = [[보통의 와르그보다 세배나 큰, 교활함으로 가득찬 눈을 가진 대형 늑대입니다.]],
