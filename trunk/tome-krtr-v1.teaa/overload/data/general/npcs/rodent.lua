...
newEntity{ base = "BASE_NPC_RODENT",
	...
	kr_display_name = "대형 수정 쥐",
	desc = [[이 쥐의 등에서는 털 대신 수정이 자라나고 있고, 그로인해 더 높은 방어력을 가집니다.]],
