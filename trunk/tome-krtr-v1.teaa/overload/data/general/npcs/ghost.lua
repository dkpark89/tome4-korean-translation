...
newEntity{ base = "BASE_NPC_GHOST",
	...
	kr_display_name = "상급 드레드",
	desc = [[불공평한 역생의 힘을 보여주는 존재입니다. 존재를 모욕하고, 생명의 흐름을 두절시키고 학대하며, 이 세상의 것 같지 않은 순수한 검정색의 사지는 쉽게 바위를 부수고 신체를 부패시킵니다.]],
...
newEntity{ base = "BASE_NPC_GHOST",
	...
	kr_display_name = "파멸의 밴시",
	desc = [[울흐'록의 브레스에 의해 만들어진 복수심에 불타는 비명을 지르는 영혼입니다. 공포의 영역의 증기가 이 구부러진 차원의 존재로부터 스며나와 다른 것들을 시들고 부패하게 만듭니다.]],
