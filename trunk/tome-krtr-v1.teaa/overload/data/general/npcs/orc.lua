...
newEntity{ base = "BASE_NPC_ORC", define_as = "ORC_FIRE_WYRMIC",
	...
	kr_display_name = "화염의 오크 용인",
	desc = [[용의 단련법으로 훈련된 사나운 오크 병사입니다.]],
...
newEntity{ base = "BASE_NPC_ORC",
	...
	kr_display_name = "암살자 오크",
	desc = [[은밀하고 치명적인 암살을 비밀리에 훈련받은 오크입니다.]],
...
newEntity{ base = "BASE_NPC_ORC",
	...
	desc = [[번들거리는 길고 검은 머리카락, 그리고 우둘투둘하며 기름진 피부를 가진 병적으로 비대한 오크입니다. 판갑을 입고 자신만큼이나 거대한 대형도끼를 들고 있습니다.]],
