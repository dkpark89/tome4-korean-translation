...
newEntity{ base = "BASE_NPC_THIEF",
	...
	kr_display_name = "소매치기",
	desc = [[최하위의 도둑입니다. 바꿔치기 기술을 막 배운 상태입니다.]],
...
newEntity{ base = "BASE_NPC_THIEF",
	...
	kr_display_name = "도둑",
	desc = [[그가 당신과 당신의 소지품을 동시에보면, 갑자기 사라집니다... 왜 짐이 가벼워진 것일까요?]],
...
newEntity{ base = "BASE_NPC_THIEF", define_as = "THIEF_BANDIT",
	...
	kr_display_name = "강도",
	desc = [[도둑질을 넘어 무식한 힘을 쓰기 시작한 악당입니다. 하지만 훔치는것도 잘 합니다.]],
...
newEntity{ base = "BASE_NPC_THIEF",
	...
	kr_display_name = "강도 두목",
	desc = [[강도 무리의 두목입니다. 부하드을 위해 경계하고 있습니다.]],
...
newEntity{ base = "BASE_NPC_THIEF", define_as = "THIEF_ASSASSIN",
	...
	kr_display_name = "암살자",
	desc = [[어렴풋이 눈이 보이기 전에... 강철이 번뜩거렸고... 죽습니다.]],
