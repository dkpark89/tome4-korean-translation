...
newEntity{ base = "BASE_NPC_SNOW_GIANT",
	...
	desc = [[영장류이지만 거대한 탑과 같은 존재입니다. 거인의 망치를 쥐고 다정하지 않은 눈빛으로 쳐다보고 있습니다.]],
...
newEntity{ base = "BASE_NPC_SNOW_GIANT",
	...
	kr_display_name = "우승자 설원 거인 불브",
	resolvers.nice_tile{image="invis.png", add_mos = {{image="npc/giant_ice_snow_giant_chieftain.png", display_h=2, display_y=-1}}},
	desc = [[동료들보다 더욱 솟아오른, 미치고 격분한 설원 거인입니다. 이 특별한 괴물의 전설을 들은 기억이 납니다. 그가 아직 입에 거품을 물고 난폭해지지 않던 시절의 일로, 그는 찾을 수 있는 모든 평평한 바위에다가 아이처럼 앉아서 이야기와 신비한 무늬를 새기고 있었다고 합니다.]],
