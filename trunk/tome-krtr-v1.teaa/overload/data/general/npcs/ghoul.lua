...
newEntity{ base = "BASE_NPC_GHOUL",
	...
	kr_display_name = "가스트",
	desc = [[이 지독한 혐오생물은 구울과 관련이 있어, 종종 구울 무리를 이끌고 다닙니다. 악취가 심하고, 이 놈에게 물리면 부패성 질병에 걸립니다.]],
...
newEntity{ base = "BASE_NPC_GHOUL",
	...
	desc = [[이 썩어가는 혐오생물에게서 악취가 피어오릅니다. 이마는 황금으로 장식되어 있습니다. 증오섞인 눈빛으로 당신에게 다가오고 있습니다.]],
...
newEntity{ base = "BASE_NPC_GHOUL", define_as = "RISEN_CORPSE",
	...
	name = "risen corpse",
	kr_display_name = "부활한 시체",
	desc = [[어둠의 마법에 의해 부활한 몸입니다.]],
	exp_worth = 1,
