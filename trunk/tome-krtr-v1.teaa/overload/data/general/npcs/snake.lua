...
newEntity{ base = "BASE_NPC_SNAKE",
	...
	kr_display_name = "큰 갈색 뱀",
	desc = [[당신을 향해 쉬릭거리는 큰 뱀입니다. 방해를 받아 화가 난 듯 합니다.]],
...
newEntity{ base = "BASE_NPC_SNAKE",
	...
	kr_display_name = "방울뱀",
	desc = [[다가서면, 똬리를 틀고 일어서고 꼬리에서 위협적인 방울 소리가 납니다.]],
...
newEntity{ base = "BASE_NPC_SNAKE",
	...
	kr_display_name = "킹코브라",
	desc = [[두건을 쓴 얼굴 같은 모양의 큰 뱀입니다.]],
...
newEntity{ base = "BASE_NPC_SNAKE",
	...
	kr_display_name = "아나콘다",
	desc = [[이 거대한 뱀을 발견하는 순간 공포로 움찔하게 됩니다. 당신을 으스러뜨리려 합니다.]],
