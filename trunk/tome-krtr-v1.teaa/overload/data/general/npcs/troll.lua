...
newEntity{ base = "BASE_NPC_TROLL",
	...
	kr_display_name = "숲 트롤",
	desc = [[못생긴 녹색 피부의 이 큰 영장류가 사마귀로 덮힌 녹색 주먹을 꽉쥐고 당신을 노려봅니다.]],
...
newEntity{ base = "BASE_NPC_TROLL",
	...
	kr_display_name = "암석 트롤",
	desc = [[우둘투둘한 검은 피부를 가진 대형 트롤입니다. 몸서리쳐지게도, 그의 거대한 허리에 감겨있는 드워프 두개골이 엮인 허리띠가 보입니다.]],
...
newEntity{ base = "BASE_NPC_TROLL",
	...
	kr_display_name = "동굴 트롤",
	desc = [[이 거대한 트롤은 무거운 창을 쥐고있고, 그 돼지같은 눈 속은 걱정될만큼 지혜롭습니다.]],
...
newEntity{ base = "BASE_NPC_TROLL",
	...
	kr_display_name = "산맥 트롤",
	desc = [[대단히 단단한 사마귀 투성이의 가죽을 가진 크고 강건한 트롤입니다.]],
...
newEntity{ base = "BASE_NPC_TROLL",
	...
	kr_display_name = "이어붙은 트롤",
	desc = [[부서진 무기를 쥐고 구역질나는 대충 이어붙인 외모를 가진 사령술로 강화된 트롤과 조금 비슷한 존재입니다. 당황하고 몹시 화가나있어, 불가능해 보이는 힘으로 주변을 모조리 찢고 부수며, 자연적이지 못한 빠른 속도로 움직입니다.]],
...
newEntity{ base = "BASE_NPC_TROLL", unique=true,
	...
	kr_display_name = "숲 트롤 울타리마법사",
	resolvers.nice_tile{tall=1},
	desc = [[이 늙어 보이는 트롤은 악의찬 눈빛으로 당신을 노려보고 있습니다. 근육은 쇠퇴했지만, 그럼에도 불구하고 어떤 힘이 그를 둘러싸고 있습니다.]],
