	...
	if game.level.turn_counter then
		...
		if game.level.turn_counter < 0 then
			...
			local m = mod.class.NPC.new{
				...
				desc = [[떠다니는 불꽃의 왕관과 세가닥의 꼬리와 날카로운 손톱만 아니라면, 이 악마는 매우 매혹적입니다. 그녀를 보는 순간 살을 파버리고 싶은 고통을 느낍니다. 그녀는 당신이 고통받기를 원합니다.]],
			...
			local o = mod.class.Object.new{
				...
				kr_display_name = "타오르는 고통의 왕관", kr_unided_name = "불타는 왕관",
				desc = [[이 순수한 불꽃의 왕관은 주변으로 떠다니는 용해된 수많은 작은 돌멩이들을 가지고 있습니다. 그 각각은 빼내어 유성같이 던질수 있습니다.]],
				add_name = " (#ARMOR#)",
