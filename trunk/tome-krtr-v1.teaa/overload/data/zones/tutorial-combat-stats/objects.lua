...
newEntity{ base = "BASE_HEAVY_BOOTS", define_as = "PHYSSAVE_BOOTS",
	...
	kr_display_name = "물리내성의 신발 (+10)", kr_unided_name = "말라붙은 오래된 신발",
	...
	encumber = 1,
	rarity = 300,
	desc = [[물리내성을 10만큼 올려주는 훌륭한 신발입니다.]],
	cost = 100,
	wielder = {
...
newEntity{ base = "BASE_AMULET", define_as = "MINDPOWER_AMULET",
	...
	kr_display_name = "정신력의 목걸이 (+3)", kr_unided_name = "화려한 목걸이",
	identified = true,
	no_unique_lore = true,
	level_range = {1, nil},
	color = colors.YELLOW,
	encumber = 1,
	rarity = 300,
	desc = [[정신력을 3만큼 올려주는 아름다운 목걸이입니다.]],
	cost = 100,
	wielder = {
		combat_mindpower = 3,
	},
...
newEntity{ base = "BASE_HELM", define_as = "ACCURACY_HELM",
	...
	kr_display_name = "정확도의 투구 (+6)",  kr_unided_name = "단단해 보이는 투구",
	...
	encumber = 1,
	rarity = 300,
	desc = [[정확도를 6만큼 올려주는 잘 만들어진 투구입니다.]],
	cost = 100,
	wielder = {
		combat_atk = 6,
	},
...
newEntity{ base = "BASE_RING", define_as = "MENTALSAVE_RING",
	...
	kr_display_name = "정신내성의 반지 (+6)", kr_unided_name = "미끈한 반지",
	identified = true,
	no_unique_lore = true,
	level_range = {1, nil},
	color = colors.YELLOW,
