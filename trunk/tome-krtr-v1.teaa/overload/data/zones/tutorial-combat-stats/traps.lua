...
newEntity{ base = "TRAP_TUTORIAL6", define_as = "TUTORIAL_TIER11",
	...
	kr_display_name = "모험가용 계몽의 지하미궁 완료",
	text = "tier11",
}
