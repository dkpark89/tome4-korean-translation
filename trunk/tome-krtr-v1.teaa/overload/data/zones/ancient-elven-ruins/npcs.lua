...
newEntity{ define_as = "GREATER_MUMMY_LORD",
	...
	kr_display_name = "고위 미이라 군주",
	display = "Z", color=colors.VIOLET,
	desc = [[이 미이라에서 흘러나오는 힘은 너무나 강대하여, 마치 미이라를 중심으로 바람이 불어나오는 것 같습니다.]],
	killer_message = "그리고 영혼 없이 이곳을 방황하는 미이라가 되었습니다.",
...
newEntity{ base = "BASE_NPC_MUMMY",
	...
	kr_display_name = "고대 엘프 미이라",
	desc = [[미이라 붕대에 휘감긴 채 되살아난 시체입니다.]],
...
newEntity{ base = "BASE_NPC_MUMMY",
	...
	kr_display_name = "움직이는 미이라 붕대",
	desc = [[되살아난 미이라지만... 그 속은 텅 비어있습니다. 움직이지 못하는 것 같습니다.]],
	level_range = {7, nil}, exp_worth = 1,
	rarity = 4,
...
newEntity{ base = "BASE_NPC_MUMMY",
	...
	kr_display_name = "썩어가는 미이라",
	desc = [[미이라 붕대에 휘감긴 채 되살아난, 썩어가는 시체입니다.]],
	level_range = {7, nil}, exp_worth = 1,
	rarity = 2,
