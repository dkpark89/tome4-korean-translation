...
newEntity{ define_as = "PALE_DRAKE",
	...
	desc = [['주인'의 소멸 이후 '불안의 영역'의 제어권을 가진 사악한 스켈레톤 마도사입니다.]],
...
newEntity{ define_as = "FILIO",
	...
	display = "s", color=colors.VIOLET,
	desc = [[발 밑에 완충제를 붙인 작고 은밀한 모습의 스켈레톤입니다. 재빠르고 조용히 움직이고, 쉽게 그림자와 동화됩니다. 한손에는 투석구를, 다른 손에는 단검을 쥐고 있습니다.
