...
newEntity{ name = "skeletal rat",
	...
	define_as = "SKELERAT",
	type = "undead",
	desc = [[사악한 에너지로 가득찬 대형 생쥐의 조그마한 해골입니다. 당신 뒤로 이 떼거지가 밀려오기 전까지는 언데드 설치류의 필요성을 아무도 몰랐습니다.]],
	color = colors.GOLD,
	level_range = {3, 4},
	exp_worth = 2,
	rank = 3,
...
newEntity{ name = "homeless fighter",
	kr_display_name = "집없는 투사",
	base = "BASE_NPC_ARENA1",
	type = "humanoid", subtype = "human",
	color = colors.BROWN,
	life_rating = 4,
	desc = "한끼를 위해 싸울 의향이 있소.",
...
newEntity{ name = "multihued wyrmic",
	...
	desc = [[여러가지 원소의 기술을 가진 강력한 용인입니다.]],
...
newEntity{ name = "master slinger",
	...
	desc = [[투기장에 고용된 숙련된 투석전사입니다. 그들은 자신의 일을 훌륭하게 수행하고 있습니다.]],
...
newEntity{ name = "gladiator",
	...
	desc = [[여흥을 목적으로하는 투기장에 고용된 용병입니다. 그들은 사람들이 실감나게 살아있음을 느끼게 만들어 줍니다.]],
...
newEntity{ name = "headless horror",
	...
	color=colors.GOLD,
	desc ="크게 확대된 배를 가진 머리없는 키다리 영장류입니다. 투기장의 최고 지배자에게 잡혔고 길들어 졌습니다.",
	...
	on_die = function(self, src)
		...
		if nb > 0 then
			game.logSeen(self, "#AQUAMARINE#%s 쓰러지자, 그의 모든 눈이 대지로 떨어집니다!", (self.kr_display_name or self.name):capitalize():addJosa("가"))
		end
	end,
}
...
newEntity{ name = "Ryal",
	...
	desc = "날개없는 이무기와 비슷하게 생긴 엄청나게 큰 뼈거인입니다. 완전한 감각을 가졌고 놀라울만큼 빠릅니다.",
	rank = 4, unique = true,
	resolvers.equip{
...
newEntity{ name = "Fryjia Loren",
	kr_display_name = "프리지아 로렌",
	define_as = "ARENA_BOSS_FRYJIA",
	type = "humanoid", subtype = "human",
	display = "@",
	color=colors.VIOLET,
	desc = [[눈과같이 창백한 피부를 가진 어린 소녀입니다. 그녀는 작지만, 전투에서는 치명적으로, 끊임없는 얼음 파편의 탄막을 펼칩니다.]],
...
newEntity{ name = "Riala Shalarak",
	kr_display_name = "리알라 샬라락",
	define_as = "ARENA_BOSS_RIALA",
	type = "humanoid", subtype = "human",
	display = "@",
	color=colors.VIOLET,
	desc = [[강한 여성 마법사입니다. 여러해 동안의 경험은 그녀를 위험한 전투원으로 만들었습니다.]],
...
newEntity{ name = "Valfren Loren",
	...
	desc = [[무거운 갑옷과 무거운 도끼를 가진 강력한 저주에 걸린 인간입니다. 영원하 싸워야하는 저주에 걸려 있습니다.]],
...
newEntity{ name = "Rej Arkatis",
	...
	desc = [[존경할만한 기술을 가진 코르낙 투사입니다. 진정한 격투의 달인이 된 이후 어디에서도 나타나지 않았었습니다.]],
...
newEntity{ name = "slinger",
	kr_display_name = "투석전사",
	base = "BASE_NPC_ARENA1",
	type = "humanoid", subtype = "human",
	color=colors.UMBER,
	life_rating = 8, stats = { str = 7, dex = 10, cun = 10, mag = 1, con = 7 },
	desc = [[당신처럼 재산과 영광을 위해 투기장을 찾은 장거리 투사입니다.]],
...
newEntity{ name = "alchemist",
	...
	desc = [[폭발하는 보석으로 공격하는 치명적인 투사입니다.]],
...
newEntity{ name = "blood mage",
	...
	stats = { str = 7, dex = 11, cun = 1, mag = 11, con = 6 },
	desc = [[검은 로브를 입은 사람입니다. 그 불길한 찬가를 들으면 당신이 약해지는 것을 느낍니다.]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 40,
	equipment = resolvers.equip{
...
newEntity{ name = "hexer",
	...
	desc = [[검은 로브를 입은 사람입니다. 수천가지의 저주가 당신에게 쏟아지는 것을 느낍니다.]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 10,
	equipment = resolvers.equip{
...
newEntity{ name = "rogue",
	...
	desc = [[속임수로 승리를 획득하려하는 은밀한 투사입니다. 조심하지 않으면 시야까지 빼앗겨 버립니다!]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 60,
	resolvers.equip{
...
newEntity{ name = "trickster",
	...
	desc = [[속임수로 승리를 획득하려하는 은밀한 투사입니다. 조심하지 않으면 심장이 뚫려있을지도 모릅니다!]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 60,
	resolvers.equip{
...
newEntity{ name = "ice wyrmic",
	kr_display_name = "얼음의 용인",
	base = "BASE_NPC_ARENA1",
	type = "humanoid", subtype = "human",
	color=colors.BLUE,
	resolvers.drops{chance=30, nb=1, {type="scroll"}},
	stats = { str = 10, dex = 10, mag = 10, con = 9, wil = 15},
	desc = [[토너먼트에서 우승하고자하는 포부를 가진 얼음의 용인입니다. 화염의 용인과 짝지어 나왔습니다.]],
	level_range = {1, nil}, exp_worth = 1, autolevel = "wyrmic",
	rarity = 1,
	female = true,
	max_life = resolvers.rngavg(90,105),
...
newEntity{ name = "sand wyrmic",
	kr_display_name = "모래의 용인",
	base = "BASE_NPC_ARENA1",
	type = "humanoid", subtype = "human",
	color = {r = 204, g = 255, b = 95},
	resolvers.drops{chance=30, nb=1, {type="scroll"}},
	stats = { str = 10, dex = 10, mag = 10, con = 9, wil = 15},
	desc = [[토너먼트에서 우승하고자하는 포부를 가진 모래의 용인입니다. 폭풍의 용인과 짝지어 나왔습니다.]],
	level_range = {1, nil}, exp_worth = 1, autolevel = "wyrmic",
	rarity = 1,
	max_life = resolvers.rngavg(90,105),
...
newEntity{ name = "storm wyrmic",
	kr_display_name = "폭풍의 용인",
	base = "BASE_NPC_ARENA1",
	type = "humanoid", subtype = "human",
	color=colors.WHITE,
	resolvers.drops{chance=30, nb=1, {type="scroll"}},
	stats = { str = 10, dex = 10, mag = 10, con = 9, wil = 15},
	desc = [[토너먼트에서 우승하고자하는 포부를 가진 폭풍의 용인입니다. 모래의 용인과 짝지어 나왔습니다.]],
	level_range = {1, nil}, exp_worth = 1, autolevel = "wyrmic",
	rarity = 1,
	female = true,
	max_life = resolvers.rngavg(90,105),
...
newEntity{ name = "anorithil",
	...
	desc = [[멀리서 온 전사입니다. 그들은 빛과 어둠의 힘을 사용할 수 있습니다!]],
	level_range = {15, nil}, exp_worth = 2,
	rarity = 10,
	max_life = 120,
	resolvers.equip{
...
newEntity{ name = "sun paladin",
	...
	desc = [[멀리서 온 전사입니다. 그들은 빛의 힘과 검으로 무장하고 있습니다.]],
	level_range = {15, nil}, exp_worth = 2,
	rarity = 10,
	max_life = 150,
	resolvers.equip{
...
newEntity{ name = "star crusader",
	...
	desc = [[멀리서 온 전사입니다. 그들은 빛의 힘과 검으로 무장하고 있고, 어둠의 힘까지 쓸 수 있습니다.]],
	level_range = {20, nil}, exp_worth = 2,
	rarity = 10,
	max_life = 150,
	stun_immune = 0.9,
