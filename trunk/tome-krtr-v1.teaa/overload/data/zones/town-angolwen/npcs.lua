...
newEntity{ define_as = "SUPREME_ARCHMAGE_LINANIIL",
	...
	kr_display_name = "앙골웬의 고위 마도사 리나니일",
	...
	desc = [[노출이 있는 실크 로브를 입은 키가 크고 창백한 여성입니다. 그녀의 시선은 대상을 태울듯이 매우 강렬합니다.]],
...
newEntity{ base = "BASE_NPC_ANGOLWEN_TOWN",
	...
	kr_display_name = "견습 마법사",
	desc = [[마법의 길을 걷는 견습 마법사입니다.]],
