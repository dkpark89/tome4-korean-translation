...
newEntity{ define_as = "BEN_CRUTHDAR_ABOMINATION",
	...
	kr_display_name = "혐오생물 벤 크루쓰달",
	display = "p", color=colors.VIOLET,
	desc = [[이 정신나간 미친 녀석은 시간의 힘에 의해 비틀리고 타락한 것 같습니다. 그 육체는 변화하여 비현실적인 위상을 가집니다.]],
...
newEntity{ define_as = "ABOMINATION_RANTHA",
	...
	desc = [[손톱과 이빨. 얼음과 죽음. 이것을 보면 용은 멸종한 게 아닌것 같습니다... 그리고 이 것은 시간의 균열에 의해 타락한 것처럼 보입니다.]],
	level_range = {15, nil}, exp_worth = 2,
