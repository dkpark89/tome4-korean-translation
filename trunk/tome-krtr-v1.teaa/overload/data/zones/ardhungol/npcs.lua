...
newEntity{ define_as = "UNGOLE", base = "BASE_NPC_SPIDER",
	...
	name = "Ungole", color=colors.VIOLET, unique = true,
	kr_display_name = "운골뢰",
	...
	killer_message = "그리고 태양의 기사와 함께 잡아먹혔습니다.",
	...
	on_die = function(self, who)
		...
		local chat = Chat.new("ardhungol-end", {name="Sun Paladin Rashim", kr_display_name="태양의 기사 라심"}, game.player:resolveSource())
		chat:invoke()
	end,
}
