...
newEntity{ base = "BASE_SCROLL", subtype="tome",
	...
	kr_display_name = "열화의 서적", kr_unided_name = "타오르는 책",
	desc = "이 커다란 책은 불꽃의 낙인이 찍힌 표지로 싸여있습니다. 아직 그것이 당신을 해치지는 않고 있습니다.",
	color = colors.VIOLET,
	level_range = {35, 45},
	rarity = 200,
	cost = 100,
...
newEntity{ base = "BASE_SCROLL", subtype="tome",
	...
	kr_display_name = "절대영도의 서적", kr_unided_name = "얼어붙은 책",
	desc = "이 커다란 책은 서서히 변화하는 얼음의 문양이 찍혀 있습니다. 아직 그것이 당신을 해치지는 않고 있습니다.",
	color = colors.VIOLET,
	level_range = {35, 45},
	rarity = 200,
	cost = 100,
