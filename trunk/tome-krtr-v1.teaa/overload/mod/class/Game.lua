...
function _M:updateZoneName()
	...
	if self.zone.display_name then
		if self.zone.kr_display_name_f then name = self.zone.kr_display_name_f().." ["..self.zone.display_name().."]" else name = self.zone.display_name() end --@@ 지역의 특수 이름 존재시 특수 이름 사용 
	else
