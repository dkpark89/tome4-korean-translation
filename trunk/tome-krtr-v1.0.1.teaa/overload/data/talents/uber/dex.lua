...
uberTalent{
	...
	info = function(self, t)
		...
		또한 당신은 군중 속에서도 깔끔하게 싸우는 방법을 배워, 이 기술이 유지되는 동안 절대 동료나 중립적인 존재에게 피해를 주지 않게 됩니다.]])
		:format()
	end,
}
...
uberTalent{
	...
	info = function(self, t)
		return ([[재빠른 손놀림을 익혀, 보조장비로 교체할 때 턴 소모가 되지 않습니다 (기본 단축키 : q). 또한 장비를 착용하거나 착용 해제를 하는 때에도 턴 소모가 되지 않습니다.
