...
newTalent{
	...
	info = function(self, t)
		...
		또한 지속시간 동안, 보이지 않는 적을 공격할 때 생기는 불리함을 무시할 수 있게 됩니다.]]):
		format(t.getDuration(self, t), t.getAtk(self, t)) --@ 변수 순서 조정
	end,
}
...
newTalent{
	...
	info = function(self, t)
		return ([[숙련된 전투 경험을 통해, 체력을 보다 효율적으로 회복합니다. (체력 +%0.2f/턴)]]):format(self:getTalentLevel(t) / 2)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		return ([[신진대사를 가속시켜, 생명력을 보다 빠르게 회복합니다. (생명력 +%0.2f/턴)]]):format(self:getTalentLevel(t) * 2.5)
	end,
}
