...
newTalent{
	...
	info = function(self, t)
		...
		기술 레벨이 4 이상이면, 대상을 빙결시킬 확률이 생기게 됩니다.
		이 기술의 레벨이 오를 때마다, 냉기 저항력이 1%% 상승합니다.]]):format(100 * t.damagemult(self, t))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		이 기술의 레벨이 오를 때마다, 냉기 저항력이 1%% 상승합니다.]]):format(3 + math.floor(self:getTalentLevel(t) / 2) * 2, t.getDuration(self, t))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		return ([[전방 %d 칸 반경에 냉기 브레스를 뿜어내, %0.2f 냉기 피해를 주고 25%% 확률로 적을 몇 턴 동안 빙결시킵니다. (적의 등급이 높으면 빙결 시간이 짧아집니다)
