...
newTalent{
	...
	info = function(self, t)
		return ([[피부를 산성으로 만들어, 자신을 공격한 적에게 %0.2f 산성 피해를 주고 %d%% 확률로 3 턴 동안 무장을 해제시킵니다.]]):format(damDesc(self, DamageType.ACID, self:combatTalentMindDamage(t, 10, 50)), t.getChance(self, t))
	end,
}
