...
newBirthDescriptor{
	type = "class",
	name = "Psionic",
	kr_name = "초능력자 (Psionic)",
	locked = function() return profile.mod.allow_build.psionic end,
	locked_desc = "육신의 약함은 정신의 단련으로 극복할 수 있다. '길' 을 찾고 '길' 을 위해 싸워 그대의 정신을 개방하라.",
	desc = {
		"초능력자는 자신의 내면에서 힘을 끌어냅니다. 고도의 수련을 거친 정신력으로 다양한 대상에서 힘을 끌어내며, 이를 물리적 효과로 변환하여 방출할 수 있습니다.",
	},
	descriptor_choices =
	{
		subclass =
...
newBirthDescriptor{
	type = "subclass",
	name = "Solipsist",
	kr_name = "유아론자 (Solipsist)",
	locked = function() return profile.mod.allow_build.psionic_solipsist end,
	locked_desc = "세계는 그들이 살면서 꾸는 꿈의 퇴적에 지나지 않는다고 믿는 자들도 있다. 그들의 잠을 깨워, 꿈의 잠재력을 개방하라.",
	desc = {
