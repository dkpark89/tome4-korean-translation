...
newEntity{
	...
	name = "Mummified Egg-sac of Ungol梨?, image = "object/artifact/mummified_eggsack.png",
	level_range = {20, 35},
	rarity = 190,
...
newEntity{ base = "BASE_CLOTH_ARMOR",
	power_source = {nature=true},
	unique = true,
	name = "Spider-Silk Robe of Spydr梨?, color = colors.DARK_GREEN, image = "object/artifact/robe_spider_silk_robe_spydre.png",
