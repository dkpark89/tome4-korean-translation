...
newBirthDescriptor{
	...
	desc =
	{
		...
		"악몽 난이도에서 로그라이크식 영구사망 모드로 플레이하면, 악몽 등급의 업적을 달성할 수 있습니다.",
	},
	descriptor_choices =
	{
		race = { ["Tutorial Human"] = "forbid", },
...
newBirthDescriptor{
	...
	desc =
	{
		...
		"아주 불리한 게임 설정입니다. 정신 나간 난이도지만, 그래도 이걸 고르면 멋있어보이기는 할겁니다.",
		"모든 지역의 레벨이 120% + 5 증가됩니다.",
		"모든 적들의 기술 레벨이 100% 증가됩니다.",
		"플레이어의 등급이 '정예' 가 아닌 '보통' 으로 설정됩니다.",
		"정신나간 난이도에서 로그라이크식 영구사망 모드로 플레이하면, 정신나간 등급의 업적을 달성할 수 있습니다.",
	},
	descriptor_choices =
	{
		race = { ["Tutorial Human"] = "forbid", },
...
newBirthDescriptor{
	...
	locked_desc = "Insane is for the weak! Bring on the true mind-shattering experience!", --@@ 한글화 필요 : #240~250
	desc =
	{
