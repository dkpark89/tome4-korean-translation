	...
	action = function(self, t)
		local d d = self:showInventory("어느 갑옷을 재구성합니까?", self:getInven("INVEN"), function(o) return not o.quest and o.type == "armor" and not o.fully_reshaped end, function(o, item)
			if (o.old_fat or 0) < t.fat_red(self, t) or o.wielder.combat_armor < o.orig_arm + t.arm_boost(self,t) then	-- Allow armor only improvements
				...
				if not o.been_reshaped then
					o.orig_name = o.name
					o.orig_kr_name = o.kr_name or o.name
					o.been_reshaped = true
				end
				o.kr_name = "재구성된["..tostring(t.arm_boost(self,t))..","..tostring(o.wielder.fatigue-o.orig_fat).."%] "..(o.orig_kr_name or o.orig_name) --@@ 검사 필요
