...
InventoryUI.default_tabslist = function(self)
	...
	if self.actor:attr("has_transmo") then tabslist[#tabslist+1] = {image="metal-ui/inven_tabs/chest.png", kind="transmo", desc="번환 상자", filter=function(o) return o.__transmo end} end
