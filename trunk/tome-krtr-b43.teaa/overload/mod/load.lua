...
-- Body parts
ActorInventory:defineInventory("MAINHAND", "편한쪽 손", true, "대부분의 무기는 편한쪽 손으로 쥡니다.", nil, {equipdoll_back="ui/equipdoll/mainhand_inv.png"})
ActorInventory:defineInventory("OFFHAND", "반대쪽 손", true, "반대쪽 손으로는 방패를 잡거나 보조 무기를 듭니다.", nil, {equipdoll_back="ui/equipdoll/offhand_inv.png"})
ActorInventory:defineInventory("PSIONIC_FOCUS", "염동력", true, "염동력으로 물체를 잡을 수 있습니다. 여기에는 전투를 위해 무기를 들 수도 있고, 아이템이 주는 혜택을 받기 위해 다른 아이템을 잡을 수도 있습니다.", nil, {equipdoll_back="ui/equipdoll/psionic_inv.png"})
ActorInventory:defineInventory("FINGER", "손가락", true, "손가락에는 반지를 끼울 수 있습니다.", nil, {equipdoll_back="ui/equipdoll/ring_inv.png"})
ActorInventory:defineInventory("NECK", "목", true, "목 주변에 장신구를 걸칠 수 있습니다.", nil, {equipdoll_back="ui/equipdoll/amulet_inv.png"})
ActorInventory:defineInventory("LITE", "조명장치", true, "광원은 세상의 어두운 장소를 볼 수 있도록 도와줍니다.", nil, {equipdoll_back="ui/equipdoll/light_inv.png"})
ActorInventory:defineInventory("BODY", "갑옷", true, "갑옷은 물리적 공격으로부터 보호해 줍니다. 갑옷이 무거울수록 기술이나 주문을 사용하는데 더 많이 방해됩니다.", nil, {equipdoll_back="ui/equipdoll/body_inv.png"})
ActorInventory:defineInventory("CLOAK", "망토", true, "망토는 체온을 유지할수 있게 도와줍니다. 마법이 걸린 것을 찾는다면 엄청난 힘을 제공하는 것도 있습니다.", nil, {equipdoll_back="ui/equipdoll/cloak_inv.png"})
ActorInventory:defineInventory("HEAD", "머리", true, "머리에는 모자나 투구 혹은 왕관을 쓸 수 있습니다.", nil, {equipdoll_back="ui/equipdoll/head_inv.png"})
ActorInventory:defineInventory("BELT", "허리", true, "허리에는 허리끈을 걸칩니다.", nil, {equipdoll_back="ui/equipdoll/belt_inv.png"})
ActorInventory:defineInventory("HANDS", "손", true, "손에는 여러가지 장갑을 낄 수 있습니다.", nil, {equipdoll_back="ui/equipdoll/hands_inv.png"})
ActorInventory:defineInventory("FEET", "발", true, "발에는 신발을 신을 수 있습니다.", nil, {equipdoll_back="ui/equipdoll/boots_inv.png"})
ActorInventory:defineInventory("TOOL", "도구", true, "여기에는 언제든 바로 쓸 수 있도록 도구를 준비해 둡니다.", nil, {equipdoll_back="ui/equipdoll/tool_inv.png"})
ActorInventory:defineInventory("QUIVER", "탄환", true, "준비된 탄환입니다.", nil, {equipdoll_back="ui/equipdoll/ammo_inv.png"})
ActorInventory:defineInventory("GEM", "보석 구멍", true, "보석이 들어갈 구멍입니다.", nil, {equipdoll_back="ui/equipdoll/gem_inv.png"})
ActorInventory:defineInventory("QS_MAINHAND", "보조 장비: 편한쪽 손", false, "두번째 무장: 대부분의 무기는 편한쪽 손으로 쥡니다. 'x'를 누르면 준비된 무장을 바꿀 수 있습니다.", true)
ActorInventory:defineInventory("QS_OFFHAND", "보조 장비: 반대쪽 손", false, "두번째 무장: 반대쪽 손으로는 방패를 잡거나 보조 무기를 듭니다. 'x'를 누르면 준비된 무장을 바꿀 수 있습니다.", true)
ActorInventory:defineInventory("QS_PSIONIC_FOCUS", "보조 장비: 염동력", false, "두번째 무장: 염동력으로 물체를 잡을 수 있습니다. 여기에는 전투를 위해 무기를 들 수도 있고, 아이템이 주는 혜택을 받기 위해 다른 아이템을 잡을 수도 있습니다. 'x'를 누르면 준비된 무장을 바꿀 수 있습니다.", true)
ActorInventory:defineInventory("QS_QUIVER", "보조 장비: 탄환", false, "두번째 무장: 준비된 탄환입니다.", true)
...
InventoryUI.default_tabslist = function(self)
	local tabslist = {
		...
		{image="metal-ui/inven_tabs/jewelry.png", 	kind="jewelry",		desc="반지와 목걸이",		filter=function(o) return not o.__transmo and (o.type == "jewelry") end},
		{image="metal-ui/inven_tabs/gems.png", 		kind="gems",		desc="보석"		,		filter=function(o) return not o.__transmo and (o.type == "gem" or o.type == "alchemist-gem") end},
		...
		{image="metal-ui/inven_tabs/quests.png", 	kind="quests",		desc="퀘스트와 이야기에 얽힌 물품",	filter=function(o) return not o.__transmo and (o.plot or o.quest) end},
	}
