...
newEntity{ define_as = "ARENA_BOOTS_PHAS", name = "a pair of leather boots of phasing",
	...
	use_power = { name = "blink to a nearby random location", kr_name = "임의의 위치로 단거리 순간이동", power = 15, use = function(self, who)
