...
newTalent{
	...
	info = function(self, t)
		...
		한번에 하나의 육신만을 조종할 수 있습니다, if this spell is cast again it will dispell the previous husk, even if no new one is created.
		보스, 언데드, 소환된 적은 조종할 수 없습니다.
		피해량과 성공 확률은 주문력의 영향을 받아 증가합니다.]]): --@@ 한글화 필요 : 두줄 위
