...
newTalent{
	...
	info = function(self, t)
		...
		return ([[잠재의식을 불러내, 매 턴마다 최대 %d 개의 정신력으로 이루어진 화살을 발사하여 %0.2f 정신 피해를 줍니다. (적 1 마리 당 화살 1 개) 화살 1 개 당 반발력이 5 소진됩니다.
...
newTalent{
	...
	info = function(self, t)
		...
		힘의 순환을 위해서는 반작용 수치를 조금이라도 가지고 있어야 합니다.
...
newTalent{
	...
	info = function(self, t)
		...
		이 기술은 피해 증가량은 정신력의 영향을 받아 증가합니다.]]):format(duration, damDesc(self, DamageType.MIND, crit_bonus))
	end,
}
