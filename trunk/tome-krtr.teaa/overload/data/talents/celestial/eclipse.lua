...
newTalent{
	...
	info = function(self, t)
		...
		return ([[당신의 주문이 치명타로 적중할 때마다, 10 타일 반경 내에 있는 %d 대상에게 빛이나 어둠의 볼트를 발사하여 %0.2f 의 빛 피해나 %0.2f 의 어둠 피해를 줍니다.
...
newTalent{
	...
	info = function(self, t)
		...
		return ([[이 강력한 주문을 유지하는 동안 %d 의 투명화 능력을 얻으며, 매 턴마다 %d 의 음기를 양기로 전환합니다. 양기가 음기를 초과하게 되거나 유지를 해제하면, 효과가 끝나면서 찬란한 빛이 폭발하면서 양기의 총량에 %0.2f 의 피해를 추가하여 %d 타일 반경 내의 모든 대상에게 줍니다.
