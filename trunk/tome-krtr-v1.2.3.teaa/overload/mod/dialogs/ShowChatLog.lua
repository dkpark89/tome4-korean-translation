...
function _M:init(title, shadow, log, chat)
	...
	tabs[#tabs+1] = {top=0, left=0, ui = Tab.new{title="게임 기록", fct=function() end, on_change=function() local i = #tabs self:switchTo(tabs[1]) end, default=true}, tab_channel="__log" }
