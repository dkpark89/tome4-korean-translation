...
newEntity{
	...
	kr_name = "지렁이 여왕의 심장", kr_unided_name = "맥동하는 장기",
	desc = [[지렁이 여왕의 죽은 몸에서 떼어낸 심장입니다.
자신이 충분히 정신 나간 사람이라면, 한번 먹어볼 수도 있습니다... 혹은 어디선가 이것을 타락시킬 수 있을지도 모릅니다.]],
	cost = 3000,
	quest = 1,
	...
	use_simple = { name="consume the heart", kr_name="심장 먹기", use = function(self, who)
		...
		if not who:attr("forbid_nature") then
			...
			game.logPlayer(who, "#00FF00#당신은 자연과의 친화력을 얻어, 이제 새로운 기술계열 '조화' 를 배울 수 있습니다. ('p' 키를 눌러 확인할 수 있습니다)")
...
newEntity{
	...
	display = "*", color=colors.VIOLET,
	kr_name = "용의 담즙", kr_unided_name = "부패한 물약",
	...
	use_simple = { name="drink the vile blood", kr_name="불결한 피 섭취", use = function(self, who)
		...
		game.log("사용할 수 있는 기술계열 점수 %d점이 있습니다. 'p' 키를 눌러 사용할 수 있습니다.", who.unused_talents_types)
