...
newEntity{ base = "BASE_SCROLL", define_as = "NOTE_FROM_LAST_HOPE",
	...
	kr_name = "마지막 희망의 봉인된 두루마리",
	image = "object/letter1.png",
	fire_proof = true,

	use_simple = { name="open the seal and read the message", kr_name="봉인을 풀고 전언 읽기", use = function(self, who)
