...
local function floorEffect(t)
	...
	t.kr_name = t.kr_name or t.name or t.kr_desc or t.desc
	...
	t.status = "neutral"
	t.parameters = {}
	t.on_gain = function(self, err) return nil, "+"..(t.kr_desc or t.desc) end
	t.on_lose = function(self, err) return nil, "-"..(t.kr_desc or t.desc) end
