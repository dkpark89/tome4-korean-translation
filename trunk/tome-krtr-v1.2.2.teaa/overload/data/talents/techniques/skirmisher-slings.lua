...
newTalent {
	...
	info = function(self, t)
		return ([[투석구 탄환을 빠르게 발사하여, %d%% 피해를 가합니다. 이 공격은 기존 공격보다 2 배 빠르게 공격하며, 이동할 때마다 재사용 대기 시간이 추가로 1 감소합니다.]])
...
newTalent {
	...
	info = function(self, t)
		return ([[조준한 뒤, 최대 %d 발의 탄환을 원뿔 모양 공격 범위 내의 모든 적들에게 동시에 발사하여 %d%% 무기 피해를 가합니다. 각각의 적은 한 발의 탄환만 맞게 됩니다. (기술 레벨이 3 이상일 경우, 한 명의 적이 2 발까지 맞게 됩니다) 속사를 사용하면 기술의 재사용 대기 시간이 1 추가로 줄어듭니다.]])
